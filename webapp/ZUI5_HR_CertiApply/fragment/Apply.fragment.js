        ...
        sap.ui.jsfragment("ZUI5_HR_CertiApply.fragment.Apply", {
            createContent: function (oController) {
                ...
                var oZLang = new sap.m.ComboBox({
                    width: "150px",
                    items: [new sap.ui.core.ListItem({ key: "1", text: "{i18n>LABEL_65018}" }), new sap.ui.core.ListItem({ key: "2", text: "{i18n>LABEL_65019}" })],
                    selectedKey: "{Zlang}",
                    editable: {
                        // 재신청일 경우 수정 불가
                        path: "actmode",
                ...
                var oDialog = new sap.m.Dialog({
                    ...
                    content: [oApplyBox, oInfoBox, oInfoBox2]
                })
