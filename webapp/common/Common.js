...
common.Common = {
	...
	*/
	...
	encryptPernr: function (vPernr, isPromise) {
		...
		if (!vPernr) {
			return new Promise(function (resolve, reject) { reject($.app.getController().getBundleText("MSG_00075")); }); // 대상자 사번이 없습니다.
		}
					...
					sap.ui.getCore().getModel("ZHR_COMMON_SRV")
						.read("/EmpLoginInfoSet", {
							...
							filters: [
								...
								new sap.ui.model.Filter("Percod", sap.ui.model.FilterOperator.EQ, vPercod), // Proxy 대상자 암호화 사번
								new sap.ui.model.Filter("Langu", sap.ui.model.FilterOperator.EQ, Langu),
								new sap.ui.model.Filter("ICusrid", sap.ui.model.FilterOperator.EQ, sessionStorage.getItem('ehr.odata.user.percod')), // HASS 담당자의 암호화 사번
								new sap.ui.model.Filter("ICusrse", sap.ui.model.FilterOperator.EQ, sessionStorage.getItem('ehr.session.token')), // HASS 담당자의 session token
								new sap.ui.model.Filter("ICusrpn", sap.ui.model.FilterOperator.EQ, sessionStorage.getItem('ehr.sf-user.name')), // HASS 담당자의 사번
