                    ...
                    rows : [new sap.ui.commons.layout.MatrixLayoutRow({height : "10px"}),
                            new sap.ui.commons.layout.MatrixLayoutRow({
                                ...
                                cells : [new sap.ui.commons.layout.MatrixLayoutCell({
                                        ...
                                        new sap.ui.commons.layout.MatrixLayoutCell({
                                            content : [new sap.m.Text({text : "{i18n>LABEL_63009}", textAlign : "Center"}).addStyleClass("font-bold")], // 재근시간기준
                                            hAlign : "Center",
                                            vAlign : "Middle"
                                        }).addStyleClass("Label2"),
                                        new sap.ui.commons.layout.MatrixLayoutCell({
                            ...
                            new sap.ui.commons.layout.MatrixLayoutRow({
                                ...
                                cells : [new sap.ui.commons.layout.MatrixLayoutCell({
                                            content : [new sap.m.Toolbar({
                                                            height : "45px",
                                                            content : [new sap.m.Text({text : "{i18n>LABEL_63014}"}).addStyleClass("sub-title")] // 유의사항
                            ...
                            new sap.ui.commons.layout.MatrixLayoutRow({
                                cells : [new sap.ui.commons.layout.MatrixLayoutCell({
                                            content : [new sap.m.FormattedText({
                                                            ...
                                                            htmlText : "<span>" + "{i18n>MSG_63001}" + "</span><br/>" +
                                                                        // ▶ 적발시 인사상 징계 및 자율출퇴근제 대상에서 제외
                                                                        "<span class='color-info-red pl-10px'>" + "{i18n>MSG_63002}" + "</span><br/>" + 
                                                                        // ※ 일일 재근 시간이 9시간 미만이더라도 점심시간(13시) 이후 퇴근 시 휴게시간 30분 + 비근무시간 30분 자동차감
                                                                        "<span class='pl-10px'>" + "{i18n>MSG_63003}" + "</span><br/>" + 
                                                                        // (점심시간을 다 쉬지 못한 경우 비근무시간은 조정가능하나 
                                                                        "<span class='pl-23px'>(" + "{i18n>MSG_63004}" + "</span>" + 
                                                                        "<span class='color-info-red'> " + "{i18n>MSG_63005}" + "</span><span>)</span><br/>" + // 허위조정금지
                                                                        // • 휴게시간/비근무시간 차감 관련 세부기준 : 열린도움방 → 회사생활안내 → 자율출퇴근제 참조
                                                                        "<span>" + "{i18n>MSG_63006}" + "</span>"
                                                        })],
                                            hAlign : "Begin",
                                            vAlign : "Middle"
