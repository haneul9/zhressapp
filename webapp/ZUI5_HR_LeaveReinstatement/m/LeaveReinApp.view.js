    ...
    function (Common, PageHelper, PickOnlyDateRangeSelection, PickOnlyDatePicker, ViewTemplates) {
        ...
        sap.ui.jsview(SUB_APP_ID, {
            ...
            ApplyingBox: function (oController) {
                ...
                var oTypeCombo = new sap.m.ComboBox({
                    // 휴/복직 구분
                    //	width: "220px",
                ...
                var oUsedTypeCombo = new sap.m.ComboBox(oController.PAGEID + "_UsedTypeCombo", {
                    // 휴/복직 사유
                    //	width: "220px",
                ...
                var oRelationCombo = new sap.m.ComboBox({
                    // 관계
                    //	width: "220px",
                    editable: {
                        path: "Status1",
                ...
                var oPartnerCheckCombo = new sap.m.ComboBox(oController.PAGEID + "_PartnerCheckCombo", {
                    // 배우자 신청여부
                    //	width: "220px",
                    editable: {
                        path: "Status1",
                ...
                var oSickInfoBox = new sap.m.VBox(oController.PAGEID + "_SickInfoBox", {
                    // 질병정보
                    fitContainer: true,
                    items: [
                        // 질병정보
