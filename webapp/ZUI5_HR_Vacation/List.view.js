    ...
    function (MakeTable, PageHelper) {
        ...
        sap.ui.jsview("ZUI5_HR_Vacation.List", {
            ...
            createContent: function (oController) {
				...
				var col_info = [{id: "Delapptx", label: "{i18n>LABEL_48047}", plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true},
								...
								{id: "Stext1", label: "{i18n>LABEL_48012}", plabel: "", resize: true, span: 0, type: "link", sort: true, filter: true}];
