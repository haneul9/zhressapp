sap.ui.jsfragment("ZUI5_HR_Vacation.fragment.Calendar", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var oRow, oCell;
		var vHeader = [{title:oBundleText.getText("LABEL_48056"), width:"", noCalDay:"", sunday:"X", saturday:""}, // 일
		...
		// 그 날의 요일은? (일요일을 주의 시작일로 지정하기 위하여 계산)
		var theDay = ( theDate.getDay() + 7 ) % 7;
				...
				if(vHeader[j].noCalDay) {
					...
					if(preLastDate >= startPreDate) {
						...
						if(lastDate >= calDate) {
							...
							// 현재달 필드
							if(toDay === currDate) {
								// oCell.addStyleClass("calendar-today");
							}
											...
											new sap.m.Text({
												text : {
													...
													formatter : function(fVal1, fVal2){
														return fVal1 + "." + (fVal2 >= 10 ? fVal2 : "0"+fVal2);
													}
												}
											}).addStyleClass("font-bold font-15px"),
											new sap.m.Button({
												type : "Transparent",
