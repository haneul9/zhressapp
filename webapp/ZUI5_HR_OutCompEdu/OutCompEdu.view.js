...
"use strict";
	...
	sap.ui.jsview($.app.APP_ID, {
		...
		_colModel: [
			...
			{id: "Edkaj",  		label: "{i18n>LABEL_40015}"/* 교육과정 */,  plabel: "", resize: true, span: 0, type: "string",  sort: true,  filter: true, width: "20%"},
			...
			{id: "Edrom",		label: "{i18n>LABEL_40017}"/* 학습장소 */,  plabel: "", resize: true, span: 0, type: "money",   sort: false, filter: false, width: "15%"},
			{id: "Edsta",		label: "{i18n>LABEL_40018}"/* 교육기관 */,  plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "15%"},
			{id: "Repst",		label: "{i18n>LABEL_40019}"/* 보고서 */,  	plabel: "", resize: true, span: 0, type: "string",  sort: false, filter: false, width: "auto"},
