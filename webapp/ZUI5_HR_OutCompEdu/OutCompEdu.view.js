...
"use strict";
	...
	sap.ui.jsview($.app.APP_ID, {
		...
		_colModel: [
			{id: "ZlanguTxt", 	label: "{i18n>LABEL_29008}"/* CheckBox */,	plabel: "", resize: true, span: 0, type: "Check",  sort: true,  filter: true, width: "auto"},
			{id: "Begda", 		label: "{i18n>LABEL_40013}"/* 구분 */,		plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "auto"},
			{id: "Caldt", 		label: "{i18n>LABEL_40014}"/* 제출일 */,	plabel: "", resize: true, span: 0, type: "date",  sort: true,  filter: true, width: "auto"},
			{id: "Zlaorg",  	label: "{i18n>LABEL_40015}"/* 교육과정 */,  plabel: "", resize: true, span: 0, type: "string",  sort: true,  filter: true, width: "20%"},
			{id: "Zlangu2Txt",	label: "{i18n>LABEL_40016}"/* 학습기간 */,	plabel: "", resize: true, span: 0, type: "template",  sort: true,  filter: true,  width: "15%", templateGetter:"getDateFormatter1"}, 
			{id: "Suport",		label: "{i18n>LABEL_40017}"/* 학습장소 */,  plabel: "", resize: true, span: 0, type: "money",   sort: false, filter: false, width: "15%"},
			{id: "Supbg",		label: "{i18n>LABEL_40018}"/* 교육기관 */,  plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "15%"},
			{id: "Statu",		label: "{i18n>LABEL_40019}"/* 보고서 */,  	plabel: "", resize: true, span: 0, type: "string",  sort: false, filter: false, width: "auto"},
			{id: "Status",		label: "{i18n>LABEL_40020}"/* 신청부서 */,  plabel: "", resize: true, span: 0, type: "template",  sort: false, filter: false, width: "auto", templateGetter:"getUrl"},
