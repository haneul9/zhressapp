sap.ui.jsfragment("ZUI5_HR_Perinfo.fragment.Basic", {
	...
	*/
	...
	createContent : function(oController, Flag) {
		var oZzbdate, oKonfe, oGbort, oFamst, oFamdt;
		...
		oGbort = new sap.m.Input({
					 width : "100%",
					 value : "{Gbort}",
		             maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoBasicTab", "Gbort"),
 		             editable: {
					    path: "disyn",
						formatter: function(v) {
							if(v === "1") return true;
			...
			rows : [new sap.ui.commons.layout.MatrixLayoutRow({
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Toolbar({
												 	content : [new sap.m.Text({text : "{i18n>LABEL_37008}" }).addStyleClass("Font15 FontBold"), // 기본인적사항
												 			   ...
												 			   new sap.m.Button({text : "{i18n>LABEL_00119}", // 취소
												 			   					visible: {
																			    	parts : [{path: "Auth"}, {path: "disyn"}],
																					formatter: function(v1, v2) {
																						if(v1 == "E" && v2 === "1") return true;
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						...
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : "{i18n>LABEL_37015}", 
																 required :  {
																    path: "disyn" ,
