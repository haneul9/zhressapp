	...
	*/
	...
	createContent : function(oController) {
		...
		var oInsti = new sap.m.Input({
			    	    ...
			    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordScholarship", "Insti"),
			    	});
		// 전공
			...
			rows : [new sap.ui.commons.layout.MatrixLayoutRow({
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						...
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : "{i18n>LABEL_02170}", 
																 required : {
															    	path: "Slart",
																	formatter: function(v) {
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [ new sap.m.Input({
											    	    ...
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordScholarship", "Majth"),
											    	})
									 		] 
									}).addStyleClass("toolbarNoBottomLine")],
								 	 hAlign : "Begin",
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [new sap.m.Input({
											    	    ...
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordScholarship", "Degno"),
											    	})] 
										}).addStyleClass("toolbarNoBottomLine") 
									],
								 	 hAlign : "Begin",
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	content : [new sap.m.Input({
											    	    ...
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordScholarship", "Proff"),
											    	})]
										}).addStyleClass("toolbarNoBottomLine")
									 ],
								 	 hAlign : "Begin",
