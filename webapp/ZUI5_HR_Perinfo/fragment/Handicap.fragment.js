			...
			rows : [new sap.ui.commons.layout.MatrixLayoutRow({
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Toolbar({
									 				height : "45px",
												 	content : [new sap.m.Text({text : "{i18n>LABEL_37086}"}).addStyleClass("Font15 FontBold"), // 보훈 및 장애
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	  content : [
											 	...
											 	content : [	
											 			new sap.m.Input({
										 	 				value : "{Conid}",
									 	 					maxLength : common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordHandicapTableIn", "Conid"),
										 	 				width : "250px",
									 	 				    editable: {
															    path: "disyn",
																formatter: function(v) {
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	  content : [
											 	...
											 	content : [	new sap.m.Input({
										 	 				value : "{Chagr}",
									 	 					maxLength : common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordHandicapTableIn", "Chagr"),
										 	 				width : "250px",
									 	 				    editable: {
															    path: "disyn",
																formatter: function(v) {
								 	 ...
								 	 content : [
 								 	 		new sap.m.Toolbar({
											 	...
											 	content : [	
												 		new sap.m.Input({
										 	 				value : "{Chaid}",
									 	 					maxLength : common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordHandicapTableIn", "Chaid"),
										 	 				width : "250px",
									 	 				    editable: {
															    path: "disyn",
																formatter: function(v) {
					...
					// 	height : "45px",
					// 	cells : [new sap.ui.commons.layout.MatrixLayoutCell({
					// 				 content : [new sap.m.Text({text : "{i18n>LABEL_37096}" })], // 장애코드
					// 				 hAlign : "Center",
					// 				 vAlign : "Middle"
					// 			 }).addStyleClass("Label"),
					// 			 new sap.ui.commons.layout.MatrixLayoutCell({
