sap.ui.jsfragment("ZUI5_HR_Perinfo.fragment.CareerInfo", {
                                ...
                                new sap.m.Toolbar({
                                    ...
                                    content: [
                                        new sap.m.Input({
                                            ...
                                            maxLength: common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordCareer", "Arbgb")
                                        })
                                    ]
                                }).addStyleClass("toolbarNoBottomLine")
                            ],
                                ...
                                new sap.m.Toolbar({
                                    ...
                                    content: [
                                        new sap.m.Input({
                                            ...
                                            maxLength: common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordCareer", "Ort01")
                                        })
                                    ]
                                }).addStyleClass("toolbarNoBottomLine")
                            ],
                                ...
                                new sap.m.Toolbar({
                                    ...
                                    content: [
                                        new sap.m.Input({
                                            ...
                                            maxLength: common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordCareer", "Zztitle")
                                        })
                                    ]
                                }).addStyleClass("toolbarNoBottomLine")
                            ],
                                ...
                                new sap.m.Toolbar({
                                    ...
                                    content: [
                                        new sap.m.Input({
                                            ...
                                            maxLength: common.Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordCareer", "Zzjob")
                                        })
                                    ]
                                }).addStyleClass("toolbarNoBottomLine")
                            ],
