sap.ui.jsfragment("ZUI5_HR_Perinfo.fragment.AddressInfo", {
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [ new sap.m.Input({
											    	    ...
											    	    width : "200px",
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoAddressTab", "Pstlz"),
											    	}),
											    	new sap.m.Button({
								 	 ...
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [ oState,
									 				...
									 				new sap.m.Input({
											    	    ...
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoAddressTab", "Ort01"),
											    	}),
											    	new sap.m.Text({text : "{i18n>LABEL_37028}" , width : "100px", textAlign : "Center"}), // 동/읍/명
									 				new sap.m.Input({
											    	    ...
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoAddressTab", "Ort02"),
											    	}), 
											    ] 
										}).addStyleClass("toolbarNoBottomLine")
									],
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [ new sap.m.Input({
											    	    ...
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoAddressTab", "Stras"),
											    	}),
											    ] 
										}).addStyleClass("toolbarNoBottomLine")
									],
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [ new sap.m.Input({
											    	    ...
											    	    width : "300px",
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoAddressTab", "UsridLong"),
											    	}),
											    ] 
										}).addStyleClass("toolbarNoBottomLine")
									],
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [ new sap.m.Input({
											    	    ...
											    	    width : "300px",
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoAddressTab", "Usrid"),
											    	}),
											    ] 
										}).addStyleClass("toolbarNoBottomLine")
									],
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Toolbar({
									 	...
									 	content : [ new sap.m.Input({
											    	    ...
											    	    width : "300px",
											    	    maxLength : common.Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoAddressTab", "Telnr"),
											    	}),
											    ] 
										}).addStyleClass("toolbarNoBottomLine")
									],
