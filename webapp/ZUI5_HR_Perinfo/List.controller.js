...
sap.ui.define([
	...
	return CommonController.extend("ZUI5_HR_Perinfo.List", {
			...
			if(!oController._ListCondJSonModel.getProperty("/Data")){
				...
				Promise.all([
					...
					common.Common.getPromise(function() {
						$.app.getModel("ZHR_COMMON_SRV").create("/CommonCodeListHeaderSet",    //결혼여부
					  	{
					...
					common.Common.getPromise(function() {
						$.app.getModel("ZHR_COMMON_SRV").create("/CommonCodeListHeaderSet",    //FUEL
					  	{
							IBukrs: oController.getView().getModel("session").getData().Bukrs2,
							IMolga: oController.getView().getModel("session").getData().Molga,
							ILangu: oController.getView().getModel("session").getData().Langu,
        ...
        searchOrgehPernr: function(oController) {
             ...
             var       initData = {
                    ...
                    callback = function(o) {
                        ...
                        //전체 조회 OData 호출
                        if(o.Otype ==="P"){
            				oController.onPressSearchAll(o.Objid,
										 oController.getView().getModel("session").getData().Bukrs2);
                        }
                    };
		...
		onAfterShow: function(oEvent){
			...
			oController.onPressSearchAll(oController.getView().getModel("session").getData().Pernr,
										 oController.getView().getModel("session").getData().Bukrs2);
		},
        ...
        onPressSearchAll : function(vPernr, vBurks){
			...
			var search = function(){
	        	Promise.all([
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_INFO_SRV").create( // 기본인적
							"/PerinfoBasicSet",
							{
								IPernr: vPernr,
								IConType: vConType,
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_INFO_SRV").create( // Address
							"/PerinfoAddressSet",
							{
								IPernr: vPernr,
								IConType: vConType,
					...
					Common.getPromise(true, function(resolve) {	
						$.app.getModel("ZHR_PERS_INFO_SRV").create( // 차량관리
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_INFO_SRV").create( // 여권/비자관리
							"/PerinfoPassportSet",
							{
								IPernr: vPernr,
								IConType: vConType,
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_RECORD_SRV").create( // 학력사항
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_RECORD_SRV").create( // 병역사항
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_RECORD_SRV").create( // 자격면허
							"/PerRecordLicenseSet",
							{
								IPernr: vPernr,
								IConType: vConType,
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_RECORD_SRV").create( // 징계
							"/PerRecordPunishSet",
							{
								IPernr: vPernr,
								IBukrs: vBurks,
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_RECORD_SRV").create( // 발령사항
						...
						Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_PERS_RECORD_SRV").create( // 보훈 및 장애
		...
		onPassportDblClick : function(actMode) {
            ...
            if(actMode == "4")
 	   			oController.onSavePassport("4");	
			else
				oController._PassportDialog.open();
		},
		...
		onSaveCar : function(appType){
			...
			var create = function(){
				...
				detailData.Begda = saveData.Begda ? "\/Date(" + common.Common.getTime(new Date(saveData.Begda)) + ")\/" : 
													"\/Date(" + common.Common.getTime(new Date()) + ")\/";
				detailData.Endda = saveData.Endda ? "\/Date(" + common.Common.getTime(new Date(saveData.Endda)) + ")\/" : 
													"\/Date(" + common.Common.getTime(new Date(9999, 11, 31)) + ")\/";
		...
		onSaveMilitary : function(appType){
			...
			var create = function(){
				...
				detailData.Pernr = oController.getView().getModel("session").getData().Pernr;
				detailData.Begda = detailData.Begda ? "\/Date(" + common.Common.getTime(new Date(detailData.Begda)) + ")\/" : 
													"\/Date(" + common.Common.getTime(new Date()) + ")\/";
				detailData.Endda = detailData.Endda ? "\/Date(" + common.Common.getTime(new Date(detailData.Endda)) + ")\/" : 
													"\/Date(" + common.Common.getTime(new Date(9999, 11, 31)) + ")\/";
		...
		onSaveHandicap : function(appType){
			...
			var create = function(){
				...
				detailData.Endda = saveData.Endda ? "\/Date(" + common.Common.getTime(new Date(saveData.Endda)) + ")\/" : 
													"\/Date(" + common.Common.getTime(new Date(9999, 11, 31)) + ")\/";
				detailData.Idate = saveData.Idate ? "\/Date(" + common.Common.getTime(new Date(saveData.Idate)) + ")\/" : 
													null;
				createData.TableIn.push(detailData);
		...
		onChangeSlart : function(changeBelow){
			...
			if(vData.Data.Slart && vData.Data.Slart != ""){
				Promise.all([
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_COMMON_SRV").create("/CommonCodeListHeaderSet", //학교
					  	{
							IBukrs: oController.getView().getModel("session").getData().Bukrs2,
							IMolga: oController.getView().getModel("session").getData().Molga,
							ILangu: oController.getView().getModel("session").getData().Langu,
					...
					Common.getPromise(true, function(resolve) { 
						$.app.getModel("ZHR_COMMON_SRV").create("/CommonCodeListHeaderSet",  //학위
					   	{
							IBukrs: oController.getView().getModel("session").getData().Bukrs2,
							IMolga: oController.getView().getModel("session").getData().Molga,
							ILangu: oController.getView().getModel("session").getData().Langu,
					...
					Common.getPromise(true, function(resolve) {
						$.app.getModel("ZHR_COMMON_SRV").create("/CommonCodeListHeaderSet",  //전공
					   	{
							IBukrs: oController.getView().getModel("session").getData().Bukrs2,
							IMolga: oController.getView().getModel("session").getData().Molga,
							ILangu: oController.getView().getModel("session").getData().Langu,
		...
		onChangeLicnn : function(changeBelow){
			...
			if(vData.Data.Licnn && vData.Data.Licnn != ""){ 
				Promise.all([
					common.Common.getPromise(function() {
						$.app.getModel("ZHR_COMMON_SRV").create("/CommonCodeListHeaderSet",   //자격등급
					   	{
							IBukrs:  oController.getView().getModel("session").getData().Bukrs2,
							IMolga:  oController.getView().getModel("session").getData().Molga,
							ILangu:  oController.getView().getModel("session").getData().Langu,
