		...
		sap.ui.jsfragment(DIALOG_DETAIL_ID, {
			...
			buildTable: function (oController) {
				...
				ZHR_TABLES.makeColumn(oController, oTable, [{
					...
					filter: false,
					width: "18%",
					templateGetter: "getApprovalLineFunc",
					templateGetterOwner: this
				}, {
					id: "ApstaT",
					label: "{i18n>LABEL_32024}" /* 결재상태 */ ,
					plabel: "",
					resize: true,
					span: 0,
					type: "string",
