...
sap.ui.jsview("ZUI5_SF_360Review.AppMain", {
	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf zhr_ui5_5000.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_SF_360Review.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_SF_360Review.360ReviewList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_SF_360Review.360ReviewList", "ZUI5_SF_360Review.360ReviewList"));
