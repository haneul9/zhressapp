				...
				'<div class="modal-content">',
					...
					'<div class="modal-body">',
						...
						'<div class="form-row mx-3">',
							'<div class="form-group w-50 m-0 p-0">',
								'<input type="text" maxlength="10" class="form-control" id="code-mfa" />',
							'</div>',
							'<div class="form-group w-20 m-0 p-0 text-center">',
								'<input type="text" readonly="readonly" class="form-control-plaintext text-center" value="5:00" id="code-mfa-timer" />',
							'</div>',
							'<div class="form-group w-30 m-0 p-0 text-right">',
								'<button type="button" class="btn btn-outline-info w-100 fn-code-request">인증코드 발급</button>',
							'</div>',
						'</div>',
						'<div class="form-group m-3">',
					...
					'<div class="modal-footer">',
						'<button type="button" class="btn btn-primary fn-code-confirm">코드 확인</button>',
					'</div>',
				'</div>',
			'</div>',
		'</div>'
