...
fill: function() {
    ...
    return new Promise(function (resolve, reject) {
		var oModel = this._gateway.getModel("ZHR_FLEX_TIME_SRV"),
        url = 'ZHR_FLEX_TIME_SRV/FlexworktimeSummarySet',
        oEmpInfo = this._gateway.loginInfo();
		
		oModel.create("/FlexworktimeSummarySet", {
