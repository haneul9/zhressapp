    ...
    return new Promise(function(resolve, reject) {
        ...
        this._gateway.getModel('ZHR_FLEX_TIME_SRV').create('/FlexworktimeSummarySet', {
			...
			success: function(result) {
                ...
                list.append([
                    '<div class="today">',
                        '<div class="title">오늘의 근태</div>',
                        '<div class="state">', vWorStatus + vFullTime, '</div>',
                    '</div>',
                    '<div class="blue-banner">',
                        '<div class="blue-banner-title">총 근로시간</div>',
                    ...
                    '<div class="statusBar">',
                        ...
                        '<div class="hour-unit">',
                            ...
                            '<div class="unit mr-55px">', (vCtrnmH + vCtrnmM).split('시간')[0] + 'h', '</div>',
                        '</div>',
                    '</div>',
                    '<div class="worktime-list">',
                        '<div class="worktime-type">',
                            '<div class="sub-title">소정 근로시간 한도</div>',
                            '<div class="time">', vCtrnmH +  ' ' + vCtrnmM, '</div>',
                        '</div>',
                        '<div class="worktime-type">',
                            '<div class="sub-title">평일근로시간</div>',
                            '<div class="time">', vWrktmH + ' ' + vWrktmM, '</div>',
                        '</div>',
                        '<div class="worktime-type">',
                            '<div class="sub-title">연장근로시간</div>',
