        ...
        return CommonController.extend("ZUI5_HR_PensionPay.List", {
            ...
            onChangeDeamtT: function (oEvent) {
                ...
                if (isNaN(value) == true) {
                    ...
                    sap.m.MessageBox.error(oController.getBundleText("MSG_17014")); // 숫자만 입력하여 주십시오.
                    return;
                }
            ...
            onChangeData: function () {
                ...
                if (oEtpay == 0) {
                    ...
                    if (oSelfAmtT < oDeamtT) {
                        sap.m.MessageBox.error(oController.getBundleText("MSG_17017"), {
                            // 개인부담금이 0보다 작을 수는 없습니다. 다시 입력하시기 바랍니다.
                            onClose: resetData
                        });
                        ...
                        sap.m.MessageBox.error(oController.getBundleText("MSG_17016"), {
                            // 회사지원금이 개인부담금을 초과할 수 없습니다. 다시 입력하시기 바랍니다.
                            onClose: resetData
                        });
                ...
                oController._ListCondJSonModel.setProperty("/Data/SelfAmtAT", Common.numberWithCommas(oDeamtT)); // 변경 후 개인부담금
                oController._ListCondJSonModel.setProperty("/Data/TotalAmtAT", Common.numberWithCommas(oDeamtT + oSuppAmtT)); // 변경 후 합계
            },
            ...
            onPressSave: function () {
                ...
                // validation check
                if (oData.Etpay == -1) {
                    sap.m.MessageBox.error(oController.getBundleText("MSG_17011")); // 신청구분을 선택하여 주십시오.
                    return;
                } else if (!oData.DeamtT || oData.DeamtT.trim() == "" || oData.SelfAmtAT == "") {
                    sap.m.MessageBox.error(oController.getBundleText("MSG_17012")); // 증/감액을 입력하여 주십시오.
                    return;
                } else if (!oData.Checkbox || oData.Checkbox == false) {
                    sap.m.MessageBox.error(oController.getBundleText("MSG_17013")); // 동의해 주시기 바랍니다.
                    return;
                }
