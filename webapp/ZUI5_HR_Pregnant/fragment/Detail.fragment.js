		...
		var oMatrix = new sap.ui.commons.layout.MatrixLayout({
			...
			rows : [new sap.ui.commons.layout.MatrixLayoutRow({
						...
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39004")})], // 신청일
									 hAlign : "End",
									 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39013")})], // 진행상태
								 	 hAlign : "End",
								 	 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						height : "45px",
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39007"), required : true})], // 출산(예정)일
									 hAlign : "End",
									 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39006"), required : true})], // 임신시작일
								 	 hAlign : "End",
								 	 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39014"), required : true})], // 태아수
								 	 hAlign : "End",
								 	 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Input({
											 	 	...
											 	 	maxLength : common.Common.getODataPropertyLength("ZHR_BENEFIT_SRV", "PregnantApplyTableIn", "Prebn"),
													editable : {
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						height : "45px",
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39008"), required : true})], // 단축근무시간
									 hAlign : "End",
									 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.ComboBox(oController.PAGEID + "_Pampm", {
								 	 				selectedKey : "{Pampm}",
											 	 	width : "100%",
								 ...
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39015")})], // 단축근무기간(12주이내)
								 	 hAlign : "End",
								 	 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
											 	 	...
											 	 	content : [new sap.m.DatePicker({
															   ...
															   new sap.m.Text({
															   	   text : {
															   	   		...
															   	   		formatter : function(fVal1, fVal2){
															   	   			if(fVal1 && fVal2){
															   	   				return oBundleText.getText("LABEL_39019") + " " + fVal1 + " ~ " + fVal2;
															   	   			} else {
															   	   				return "";
															   	   			}
															   	   		}
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						height : "45px",
						cells : [new sap.ui.commons.layout.MatrixLayoutCell().addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell().addStyleClass("Data"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39016")})], // 단축근무기간(36주이후)
								 	 hAlign : "End",
								 	 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : oBundleText.getText("LABEL_39017")})], // 요청사항
									 hAlign : "End",
									 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
								 	 content : [new sap.m.TextArea({
											 	 	...
											 	 	rows : 2,
											 	 	growing : false,
											 	 	maxLength : common.Common.getODataPropertyLength("ZHR_BENEFIT_SRV", "PregnantApplyTableIn", "Reque"),
													editable : {
														path : "Status1",
														formatter : function(fVal){
															return (fVal == "" || fVal == "AA") ? true : false;
		...
		var oLayout = new sap.ui.layout.VerticalLayout({
			...
			content : [new sap.m.Toolbar({
						   ...
						   content : [new sap.m.ToolbarSpacer(),
									  ...
									  new sap.m.Button({
									  	  text : oBundleText.getText("LABEL_39018"), // 신청
									  	  press : function(oEvent){
