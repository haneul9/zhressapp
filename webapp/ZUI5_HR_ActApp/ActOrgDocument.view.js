	...
	sap.ui.jsview(SUB_APP_ID, {
		...
		createContent: function (oController) {
			...
			var oListPanel = new sap.m.Panel({
				...
				headerToolbar: new sap.m.Toolbar({
					...
					//	new sap.m.Image({ src: "images/Apply.gif" }),
						...
						new sap.m.ToolbarSpacer(),
						new sap.m.Button(oController.PAGEID + "_Ext_Btn", {
							text: "{i18n>LABEL_02079}",
							icon: "sap-icon://sys-find-next",
							press: oController.extPerson,
							visible: false
						}),
			...
			var oFooterBar = new sap.m.Bar(oController.PAGEID + "_FooterBar", {
				contentLeft: [
					// new sap.m.Button(oController.PAGEID + "_SORT_BTN", {
					// 	text: "{i18n>LABEL_02162}",
					// 	press: oController.onPressSort
					// }),
					// new sap.m.Button(oController.PAGEID + "_FILTER_BTN", {
					// 	text: "{i18n>LABEL_02084}",
