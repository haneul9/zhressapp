...
sap.ui.define(
	...
	function (Common, CommonController, JSONModel, BusyIndicator, MessageBox, Export, ExportTypeCSV) {
		...
		return CommonController.extend(SUB_APP_ID, {
			...
			_BasicControl: [
				{ label: "No.", id: "Recno", Align: "Center", Width: 100, control: "Text", required: false },
				{ label: "{i18n>LABEL_02041}", id: "Cfmyn", Align: "Center", Width: 40, control: "Img", required: false },
				{ label: "{i18n>LABEL_02359}", id: "Pernr", Align: "Left", Width: 100, control: "Text", required: true },
				{ label: "{i18n>LABEL_02070}", id: "Ename", Align: "Left", Width: 100, control: "Text", required: false },
				{ label: "{i18n>LABEL_02272}", id: "PerOrgeh_Tx", Align: "Left", Width: 150, control: "Text", required: false },
				{ label: "{i18n>LABEL_02219}", id: "Per_zzcaltl_Tx", Align: "Left", Width: 100, control: "Text", required: false },
				{ label: "{i18n>LABEL_02014}", id: "Actda", Align: "Left", Width: 80, control: "Date", required: true }
			],
			...
			setInputFiled: function (oController, fReent) {
				...
				if (oController._vDocty == "20") {
					...
					var oColumn = new sap.ui.table.Column({
						...
						resizable: false,
						multiLabels: [
							new sap.m.Label({ text: "No.", textAlign: "Center" }).addStyleClass("L2PFontFamily"),
							new sap.m.Label({ text: "No.", textAlign: "Center" }).addStyleClass("L2PFontFamily")
						],
						headerSpan: [1, 1],
						width: "80px",
					...
					oColumn = new sap.ui.table.Column({
						...
						resizable: false,
						multiLabels: [
							new sap.m.Label({ text: "{i18n>LABEL_02041}", textAlign: "Center" }).addStyleClass("L2PFontFamily"),
							new sap.m.Label({ text: "{i18n>LABEL_02041}", textAlign: "Center" }).addStyleClass("L2PFontFamily")
						],
						headerSpan: [1, 1],
						width: "60px",
					...
					oColumn = new sap.ui.table.Column({
						...
						resizable: false,
						multiLabels: [
							new sap.m.Label({ text: "{i18n>LABEL_02007}", textAlign: "Center" }).addStyleClass("L2PFontFamily"),
							new sap.m.Label({ text: "* {i18n>LABEL_02359}", textAlign: "Center" }).addStyleClass("L2PFontFamily")
						],
					...
					oColumn = new sap.ui.table.Column({
						...
						multiLabels: [
							new sap.m.Label({ text: "{i18n>LABEL_02007}", textAlign: "Center" }).addStyleClass("L2PFontFamily"),
							new sap.m.Label({ text: "{i18n>LABEL_02070}", textAlign: "Center" }).addStyleClass("L2PFontFamily")
						],
						headerSpan: [multiHeaderLine, 1],
						width: "100px",
						template: new sap.ui.commons.TextView({
					...
					oColumn = new sap.ui.table.Column({
						...
						multiLabels: [
							new sap.m.Label({ text: "{i18n>LABEL_02007}", textAlign: "Center" }).addStyleClass("L2PFontFamily"),
							new sap.m.Label({ text: "{i18n>LABEL_02272}", textAlign: "Center" }).addStyleClass("L2PFontFamily")
						],
						headerSpan: [multiHeaderLine, 1],
						width: "150px",
						template: new sap.ui.commons.TextView({
					...
					oColumn = new sap.ui.table.Column({
						...
						multiLabels: [
							new sap.m.Label({ text: "{i18n>LABEL_02007}", textAlign: "Center" }).addStyleClass("L2PFontFamily"),
							new sap.m.Label({ text: "* " + "{i18n>LABEL_02014}", textAlign: "Center" }).addStyleClass("L2PFontFamily")
						],
						headerSpan: [multiHeaderLine, 1],
						width: "120px",
						template: new sap.ui.commons.TextView({
					...
					if (fReent == true) {
						oColumn = new sap.ui.table.Column({
							...
							multiLabels: [
								new sap.m.Label({ text: "{i18n>LABEL_02007}", textAlign: "Center" }).addStyleClass("L2PFontFamily"),
								new sap.m.Label({ text: "* " + "{i18n>LABEL_02278}", textAlign: "Center" }).addStyleClass("L2PFontFamily")
							],
							headerSpan: [multiHeaderLine, 1],
							width: "150px",
							template: new sap.ui.commons.TextView({
					...
					for (var i = 0; i < oController._vActiveControl.length; i++) {
						...
						if (oneCol.Type == "Date") {
							oColumn = new sap.ui.table.Column({
								...
								resizable: false,
								multiLabels: [
									new sap.m.Label({ text: "{i18n>LABEL_02016}", textAlign: "Center" }),
				...
				oColumn = new sap.ui.table.Column({
					...
					width: "300px",
					multiLabels: [
						new sap.m.Label({ text: "{i18n>LABEL_02242}", textAlign: "Center" }),
						new sap.m.Label({ text: "{i18n>LABEL_02242}", textAlign: "Center" })
					],
					headerSpan: [1, 1],
					template: new sap.ui.commons.TextView({
							...
							for (var i = 0; i < data.results.length; i++) {
								if (
									...
									oColumn = new sap.ui.table.Column({
										...
										width: "100px",
										multiLabels: [
											new sap.m.Label({ text: "{i18n>LABEL_02360}", textAlign: "Center" }),
											new sap.m.Label({ text: data.results[i].Label, textAlign: "Center" })
										],
									...
									oColumn = new sap.ui.table.Column({
										...
										multiLabels: [
											new sap.m.Label({ text: "{i18n>LABEL_02360}", textAlign: "Center" }),
											new sap.m.Label({ text: data.results[i].Label, textAlign: "Center" }).addStyleClass("L2PFontFamily")
										],
										headerSpan: [data.results.length, 1],
										template: new sap.ui.commons.TextView({
											width: "100%",
					...
					if (roa.length > 0) {
						...
						for (var k = 0; k < roa.length; k++) {
							...
							if (oController._vDocty == "20") {
								...
								for (var m = 0; m < vExLength; m++) {
									...
									if (
										...
										vOneData[oController._vHiringPersonalInfomationLayout[m].Fieldname] = vTempDate;
									} else {
							...
							for (var j = 0 + vExLength; j < oController._vTableUploadField.length + vExLength; j++) {
								...
								if (vCheckData2 == "" || vCheckData2 == undefined) {
									vTempIdx++;
									continue;
								}
								...
								if (oController._vTableUploadField[vTempIdx].Incat == "M4" || oController._vTableUploadField[vTempIdx].Incat == "O4") {
									...
									controlData[oController._vTableUploadField[vTempIdx].Fieldname] = vTempDate2;
								}
								vTempIdx++;
							}
