		...
		createContent: function (oController) {
			...
			for (var i = 0; i < 1; i++) {
				...
				oCell1 = new sap.ui.commons.layout.MatrixLayoutCell({
					...
					content: [new sap.m.Label({ text: oController.getBundleText("MASSN" + (i + 1)) })]
				...
				oCell1 = new sap.ui.commons.layout.MatrixLayoutCell({
					hAlign: sap.ui.commons.layout.HAlign.Begin,
					vAlign: sap.ui.commons.layout.VAlign.Middle,
					content: [new sap.m.Label({ text: oController.getBundleText("MASSG" + (i + 1)) })]
				}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
				oRow1.addCell(oCell1);
			...
			for (var k = 1; k < 5; k++) {
				...
				oCell1 = new sap.ui.commons.layout.MatrixLayoutCell({
					hAlign: sap.ui.commons.layout.HAlign.Begin,
					vAlign: sap.ui.commons.layout.VAlign.Middle,
					content: [new sap.m.Label({ text: oController.getBundleText("MASSN" + (k + 1)) })]
				}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
				oRow1.addCell(oCell1);
				...
				oCell1 = new sap.ui.commons.layout.MatrixLayoutCell({
					hAlign: sap.ui.commons.layout.HAlign.Begin,
					vAlign: sap.ui.commons.layout.VAlign.Middle,
					content: [new sap.m.Label({ text: oController.getBundleText("MASSG" + (k + 1)) })]
				}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
				oRow1.addCell(oCell1);
			...
			var oActTypeReasonPanel = new sap.m.Panel({
				...
				headerToolbar: new sap.m.Toolbar({
					...
					//	new sap.ui.core.Icon({ src: "sap-icon://accounting-document-verification", size: "1.0rem", color: "#666666" }),
						new sap.m.Label({ text: "{i18n>LABEL_02013}", design: "Bold" }).addStyleClass("L2PFontFamily"),
			...
			var oActdHistoryPanel = new sap.m.Panel({
				...
				headerToolbar: new sap.m.Toolbar({
					...
					//	new sap.ui.core.Icon({ src: "sap-icon://expense-report", size: "1.0rem", color: "#666666" }),
						new sap.m.Label({ text: "{i18n>LABEL_02004}" }).addStyleClass("L2PFontFamily act-head-title"),
						new sap.m.ToolbarSpacer({ width: "10px" }),
						new sap.ui.core.Icon({ src: "sap-icon://information", size: "1.0rem", color: "#8DC63F" }),
						new sap.m.Label({ text: "{i18n>MSG_02006}", visible: true }).addStyleClass("L2P12Font L2P12Notice act-msg"),
						new sap.m.ToolbarSpacer(),
