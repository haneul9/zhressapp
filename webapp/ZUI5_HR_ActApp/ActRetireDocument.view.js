	...
	sap.ui.jsview(SUB_APP_ID, {
		...
		createContent: function (oController) {
			...
			oCell = new sap.ui.commons.layout.MatrixLayoutCell({
				...
				content: [new sap.m.Label({ text: "{i18n>LABEL_02051}", required: true }).addStyleClass("L2PFontFamily")]
			...
			oCell = new sap.ui.commons.layout.MatrixLayoutCell({
				hAlign: sap.ui.commons.layout.HAlign.Begin,
				vAlign: sap.ui.commons.layout.VAlign.Middle,
				content: [new sap.m.Label({ text: "{i18n>LABEL_02355}", required: true }).addStyleClass("L2PFontFamily")]
			}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
			oRow.addCell(oCell);
			...
			oCell = new sap.ui.commons.layout.MatrixLayoutCell({
				hAlign: sap.ui.commons.layout.HAlign.Begin,
				vAlign: sap.ui.commons.layout.VAlign.Middle,
				content: [new sap.m.Label({ text: "{i18n>LABEL_02356}", required: true, labelFor: oReqno }).addStyleClass("L2PFontFamily")]
			}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
			oRow.addCell(oCell);
			...
			var oListPanel = new sap.m.Panel({
				...
				headerToolbar: new sap.m.Toolbar({
					...
					content: [
						...
						new sap.m.Label({ text: "{i18n>LABEL_02007}", design: "Bold" }).addStyleClass("L2PFontFamily"),
						new sap.m.ToolbarSpacer({ width: "15px" }),
						new sap.m.Image({ src: "images/Apply.png" }),
						...
						new sap.m.ToolbarSpacer(),
						new sap.m.Button(oController.PAGEID + "_Add_Btn", { text: "{i18n>LABEL_02025}", icon: "sap-icon://add", press: oController.addPerson }),
