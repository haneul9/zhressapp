sap.ui.jsfragment("ZUI5_HR_WorkCalendarBasic.fragment.Calendar", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var y = oData.Zyymm.substring(0,4) * 1;
		var m = (oData.Zyymm.substring(4,6) * 1) - 1;
		...
		for(var i=0; i<row; i++) {
			oRow = new sap.ui.commons.layout.MatrixLayoutRow({height : "150px"});
