...
sap.ui.define([
	...
	return CommonController.extend($.app.APP_ID, {
        ...
        onPressEnd: function() { // 조기 종료 신청
			...
			this.ApplyModel.setProperty("/FormData/EarlyYears", Common.checkNull(oRowData.Zseeym) ? "" : oRowData.Zseeym.slice(0,4));
			this.ApplyModel.setProperty("/FormData/EarlyMonth", Common.checkNull(oRowData.Zseeym) ? "" : oRowData.Zseeym.slice(4));
		...
		onSelectedRow: function(oEvent) {
			...
			oController.ApplyModel.setProperty("/FormData/EarlyYears", Common.checkNull(oCopiedRow.Zseeym) ? "" : oCopiedRow.Zseeym.slice(0,4));
			oController.ApplyModel.setProperty("/FormData/EarlyMonth", Common.checkNull(oCopiedRow.Zseeym) ? "" : oCopiedRow.Zseeym.slice(4));
