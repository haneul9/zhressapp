    ...
    function (Common, DialogHandler, HomeLoan, ODataService, BankDialogHandler, FileHandler, MessageBox, BusyIndicator, JSONModel) {
        ...
        var Handler = {
            ...
            onBeforeDetailDialog: function() {
                ...
                Common.getPromise(
                    function () {
                        ...
                        results = ODataService.HouseLoanRequestSet.call(
                            this.oController, 
                            HomeLoan.ProcessType.DETAIL, 
                            {
                                Pernr: this.oController.getSessionInfoByKey("Pernr"),
                                isErrorShow: true,
                        ...
                        this.oModel.setProperty("/Detail/AttachDomains", results.TableIn3.filter(function(o) { return o.IKey === "4"; }));
                        this.oModel.setProperty("/Detail/ZhltypDomains", [{Code:"", Text:"선택"}].concat(results.TableIn3.filter(function(o) { return o.IKey === "1"; })));
                        this.oModel.setProperty("/Detail/ZmrgfgDomains", [{Code:"", Text:"선택"}].concat(results.TableIn3.filter(function(o) { return o.IKey === "2"; })));
                        this.oModel.setProperty("/Detail/BanklDomains", results.TableIn3.filter(function(o) { return o.IKey === "3"; }));
                        this.oModel.setProperty("/Detail/Header", $.extend(true, vDetailInfo, {
                            ...
                            BanklTxt: vDetailInfo.Bankl ? this.oModel.getProperty("/Detail/BanklDomains").filter(function(o) { return o.Code === vDetailInfo.Bankl; })[0].Text : "",
			...
			onAfterDetailDialog: function() {
                ...
                promises = this.oModel.getProperty("/Detail/AttachDomains").map(function(elem) {
                    return Common.getPromise(function() {
                        FileHandler.setAttachFile(this.oController, {
                            Label: elem.Text,
