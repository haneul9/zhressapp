...
sap.ui.define(
    ...
    function (Common, SearchUser1, SearchOrg, DialogHandler, OrgOfIndividualHandler, ApprovalLinesHandler, WorkSchedule, ODataService, MessageBox, BusyIndicator, Spreadsheet, JSONModel) {
        "use strict";
        ...
        var Handler = {
            ...
            pressExcelDownloadBtn: function() {
				...
				new Spreadsheet({
					...
					fileName: "${fileName}-${datetime}.xlsx".interpolate(this.oController.getBundleText("LABEL_55039"), sap.ui.core.format.DateFormat.getDateTimeInstance({pattern: "yyyy-MM-dd"}).format(new Date()))
				}).build();
            },
            ...
            pressSelectRowDetail: function (oEvent) {
                ...
                if (p.Status !== "AA" && columnId === "ZUI5_HR_WorkSchedule.Tab--PriorTableTmstaT" && p.UrlA1) { // 진행상태
            ...
            searchDetailData: function(arg) {
                ...
                this.oModel.setProperty("/Detail/VisibleApprs", results.Worktimetab2.length ? true : false);
                this.oModel.setProperty(
                    "/Detail/List",
                ...
                switch (conType) {
                    ...
                    case WorkSchedule.ProcessType.APPROVE:
                        if(!Common.isExternalIP()) {
                            if(!Common.openPopup.call(this.oController, data.Url)) {
                                BusyIndicator.hide();
                                return;
                            }
                        }
            ...
            onRequest: function(vAprdatas) {
                ...
                var Process = function (fVal) {
                    ...
                    payload.Worktimetab2 = [];
                    payload.Worktimetab3 = vAprdatas || [];
            ...
            getLinkMimicTemplate: function(columnInfo) {
                ...
                return new sap.ui.commons.TextView({
                    ...
                    text: {
                        ...
                        formatter: function(v, Status, UrlA1) {
                            this.toggleStyleClass("mimic-link", Status !== "AA" && !!UrlA1);
                            return v;
                        }
                    }
                });
