    ...
    function (Common, ZHR_TABLES, WorkSchedule) {
        ...
        sap.ui.jsfragment(TAB_PAGE_ID, {
            ...
            getColumnModel: function() {
                return [
                    { id: "TmstaT", label: "{i18n>LABEL_55002}" /* 진행상태 */, plabel: "", resize: true, span: 0, type: "template", sort: true, filter: false, width: "5%", templateGetter: "getLinkMimicTemplate", templateGetterOwner: this },
                    { id: "Schda", label: "{i18n>LABEL_55003}" /* 근무일 */, plabel: "", resize: true, span: 0, type: "date", sort: true, filter: false, width: "5%" },
                    { id: "Pernr", label: "{i18n>LABEL_00191}" /* 사번 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "5%" },
                    { id: "Ename", label: "{i18n>LABEL_00121}" /* 성명 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "5%" },
                    { id: "Rtext", label: "{i18n>LABEL_55004}" /* 근무조 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "5%" },
                    { id: "Atext", label: "{i18n>LABEL_55005}" /* 근태 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "5%" },
                    { id: "TprogT", label: "{i18n>LABEL_55006}" /* 일근유형 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "5%" },
                    { id: "PlanTime", label: "{i18n>LABEL_55007}" /* 계획근무 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "6%" },
                    { id: "InoutTime", label: "{i18n>LABEL_55008}" /* 입/출문 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "6%" },
                    { id: "WorkTime", label: "{i18n>LABEL_55009}" /* 근무시간 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "6%" },
                    { id: "AddTime1", label: "{i18n>LABEL_55010}" /* 추가시간1 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "6%" },
                    { id: "AddTime2", label: "{i18n>LABEL_55035}" /* 추가시간2 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "6%" },
                    { id: "FaprsT", label: "{i18n>LABEL_55011}" /* 사유구분 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "8%", align: "Begin" },
                    { id: "Ovres", label: "{i18n>LABEL_55012}" /* 사유 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "7%", align: "Begin" },
                    { id: "Tim00", label: "{i18n>LABEL_55013}" /* 정상 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "4%" },
                    { id: "Tim01", label: "{i18n>LABEL_55014}" /* 연장 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "4%" },
                    { id: "Tim07", label: "{i18n>LABEL_55015}" /* 심야 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "4%" },
                    { id: "Tim05", label: "{i18n>LABEL_55016}" /* 휴일 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "4%" },
                    { id: "Tim02", label: "{i18n>LABEL_55017}" /* 주휴 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: false, width: "4%" }
                ];
            }
        });
    }
