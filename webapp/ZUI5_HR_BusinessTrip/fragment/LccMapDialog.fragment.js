		...
		return new sap.m.VBox({
			...
			items: [
				...
				new sap.m.Input("LccMapDeparture", {
					...
					valueHelpOnly: true,
					showValueHelp: true,
					valueHelpRequest: LccMapDialogHandler.searchPlace.bind(LccMapDialogHandler)
				}),
				...
				new sap.m.Label({ text: "", layoutData: new sap.m.FlexItemData({ growFactor: 1 }) }),
				new sap.m.Button({
					press: LccMapDialogHandler.reloadMap.bind(LccMapDialogHandler),
					text: "{i18n>LABEL_19637}", // 지도 초기화
					width: "100%"
				})
