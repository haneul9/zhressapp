sap.ui.jsfragment("ZUI5_HR_FamilyApply.fragment.popup", {
    createContent: function (oController) {
        ...
        var oSelect1 = new sap.m.Select(oController.PAGEID + "_Sel1", {
            width: "80%",
        ...
        var oSelect2 = new sap.m.Select(oController.PAGEID + "_Sel2", {
            width: "80%",
            selectedKey: "{Kdsvh}",
            editable: {
                path: "Opener",
        ...
        var oSelect3 = new sap.m.Select(oController.PAGEID + "_Sel3", {
            width: "80%",
            selectedKey: "{Fgbld}",
            editable: {
                path: "Opener",
        ...
        var oSelect4 = new sap.m.Select(oController.PAGEID + "_Sel4", {
            width: "253px",
            selectedKey: "{Fanat}",
            editable: {
                path: "Opener",
        ...
        var oSelect5 = new sap.m.Select(oController.PAGEID + "_Sel5", {
            width: "80%",
            selectedKey: "{Fasar}",
            editable: {
                path: "Opener",
        ...
        var oRegNo = new sap.m.Input(oController.PAGEID + "_Regno", {
            width: "80%",
            value: "{Regnot}",
            maxLength: 14,
            liveChange: oController.onAutoInputReg,
        ...
        var oTxt = new sap.m.Text({ text: { path: "Fgbdt", type: new sap.ui.model.type.Date({ pattern: "yyyy-MM-dd" }) } });
        ...
        oCell = new c.layout.MatrixLayoutCell({
            hAlign: "Begin",
            content: [
                new sap.m.Input(oController.PAGEID + "_Lnmhg", {
                    placeholder: oBundleText.getText("LABEL_44040"),
                    width: "30%",
                    value: "{Lnmhg}",
                    editable: {
                        path: "Opener",
                ...
                new sap.m.Input(oController.PAGEID + "_Fnmhg", {
                    placeholder: oBundleText.getText("LABEL_44041"),
                    width: "60%",
                    value: "{Fnmhg}",
                    editable: {
                        path: "Opener",
        ...
        oCell = new c.layout.MatrixLayoutCell({
            ...
            content: [
                new sap.m.DatePicker({
                    ...
                    value: { path: "Zzbdate", type: new sap.ui.model.type.Date({ pattern: "yyyy-MM-dd" }) }
                }),
                new sap.m.CheckBox(oController.PAGEID + "_Zzclass", {
                    text: oBundleText.getText("LABEL_44033"),
                    selected: {
                        path: "Zzclass",
                        formatter: function (fVal) {
                            if (fVal && fVal == "2") {
        ...
        oCell = new c.layout.MatrixLayoutCell({
            hAlign: "Begin",
            content: new sap.m.CheckBox(oController.PAGEID + "_Dptid", {
                selected: {
                    path: "Dptid",
                    formatter: function (fVal) {
                        if (fVal && fVal == "X") {
        ...
        oCell = new c.layout.MatrixLayoutCell({
            hAlign: "Begin",
            content: new sap.m.CheckBox(oController.PAGEID + "_Livid", {
                selected: {
                    path: "Livid",
                    formatter: function (fVal) {
                        if (fVal && fVal == "X") {
        ...
        oCell = new c.layout.MatrixLayoutCell({
            hAlign: "Begin",
            content: new sap.m.CheckBox(oController.PAGEID + "_Helid", {
                selected: {
                    path: "Helid",
                    formatter: function (fVal) {
                        if (fVal && fVal == "X") {
        ...
        var oDialog = new sap.m.Dialog(oController.PAGEID + "_Dialog", {
            content: [oContent],
            buttons: [
                new sap.m.Button(oController.PAGEID + "_Re", {
                    text: oBundleText.getText("LABEL_44035"),
                    press: function () {
                        oController.onRe();
                    },
                    visible: {
                ...
                new sap.m.Button({
                    text: oBundleText.getText("LABEL_44031"),
                    press: function () {
                        oController.onSave();
                    },
                    visible: {
            ...
            contentWidth: "1366px",
            afterOpen: function () {
                oController.onAfterOpen(oDialog);
            }
        });
