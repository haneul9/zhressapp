            ...
            items: [
                new sap.m.FlexBox({
                    ...
                    items: [
                        new sap.m.FlexBox({
                            items: [
                                new sap.m.Label({text: oBundleText.getText("LABEL_43002")}), // 조회일자
                                ...
                                new sap.m.Label({text: oBundleText.getText("LABEL_43003")}), // 사업장
		...
		var oContent = new sap.m.FlexBox({
			  ...
			  items: [new sap.m.FlexBox({
						  ...
						  items: [new sap.m.FlexBox({
									  alignItems: "End",
									  fitContainer: true,
									  items: [new sap.m.Text({text: oBundleText.getText("LABEL_43001")}).addStyleClass("app-title")] // 일근태현황
