	...
	createContent: function(oController) {
						...
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.FormattedText({
													 htmlText : "<span>" + oBundleText.getText("MSG_53001") + "</span><br/>" + // • 재택근무 1일 전까지 부서장 승인을 필수로 받아야 합니다.
																...
																"<span>" + oBundleText.getText("MSG_53005") + "</span><br/>" + // • 일정 변경을 희망할 경우 '삭제신청' 후 '신규신청'하시기 바랍니다.
    	...
    	var oMatrix2 = new sap.ui.commons.layout.MatrixLayout({
    		...
    		rows : [new sap.ui.commons.layout.MatrixLayoutRow({
		    			height : "45px",
		    			cells : [new sap.ui.commons.layout.MatrixLayoutCell({
				    				 content : [new sap.m.Text({text : oBundleText.getText("LABEL_53002")}).addStyleClass("sub-title")], // 재택근무일
				    				 hAlign : "Begin",
				    				 vAlign : "Middle",
				    				 colSpan : 5
				    			 })]
		    		...
		    		new sap.ui.commons.layout.MatrixLayoutRow({
		    			height : "45px",
		    			cells : [new sap.ui.commons.layout.MatrixLayoutCell({
				    				 content : [new sap.m.Label({text : oBundleText.getText("LABEL_53002") + "1"})], // 재택근무일1
				    				 hAlign : "Center",
				    				 vAlign : "Middle"
				    			 }).addStyleClass("Label2"),
				    			 new sap.ui.commons.layout.MatrixLayoutCell({
				    				 content : [new sap.m.Label({text : oBundleText.getText("LABEL_53002") + "2"})], // 재택근무일2
				    				 hAlign : "Center",
				    				 vAlign : "Middle"
				    			 }).addStyleClass("Label2"),
				    			 new sap.ui.commons.layout.MatrixLayoutCell({
				    				 content : [new sap.m.Label({text : oBundleText.getText("LABEL_53002") + "3"})], // 재택근무일3
				    				 hAlign : "Center",
				    				 vAlign : "Middle"
				    			 }).addStyleClass("Label2"),
				    			 new sap.ui.commons.layout.MatrixLayoutCell({
				    				 content : [new sap.m.Label({text : oBundleText.getText("LABEL_53002") + "4"})], // 재택근무일4
				    				 hAlign : "Center",
				    				 vAlign : "Middle"
				    			 }).addStyleClass("Label2"),
				    			 new sap.ui.commons.layout.MatrixLayoutCell({
				    				 content : [new sap.m.Label({text : oBundleText.getText("LABEL_53002") + "5"})], // 재택근무일5
				    				 hAlign : "Center",
				    				 vAlign : "Middle"
				    			 }).addStyleClass("Label2")]
		    		}),
		...
		var oMatrix3 = new sap.ui.commons.layout.MatrixLayout({
			...
			rows : [new sap.ui.commons.layout.MatrixLayoutRow({
						height : "45px",
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Text({text : oBundleText.getText("LABEL_53009")}).addStyleClass("sub-title")], // 신청내용
									 hAlign : "Begin",
									 vAlign : "Middle",
									 colSpan : 2
								 })]
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						height : "45px",
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : oBundleText.getText("LABEL_53004"), required : true, textDirection : "RTL"})], // 연락처
									 hAlign : "End",
									 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
					...
					new sap.ui.commons.layout.MatrixLayoutRow({
						height : "45px",
						cells : [new sap.ui.commons.layout.MatrixLayoutCell({
									 content : [new sap.m.Label({text : oBundleText.getText("LABEL_53003")})], // 신청사유
									 hAlign : "End",
									 vAlign : "Middle"
								 }).addStyleClass("Label"),
								 new sap.ui.commons.layout.MatrixLayoutCell({
											  ...
											  new sap.m.FormattedText({
											  	  htmlText : {
											  	  		...
											  	  		formatter : function(fVal1){
											  	  			if(fVal1 == "" || fVal1 == "AA"){
											  	  						// 재택근무 신규신청
											  	  				return "<span class='app-title'>" + oBundleText.getText("LABEL_53010") + "</span>";
											  	  			} else {
											  	  						// 재택근무 조회
											  	  				return "<span class='app-title'>" + oBundleText.getText("LABEL_53011") + "</span>";
											  	  			}
											  	  		}
											  	  }
											  })] 
