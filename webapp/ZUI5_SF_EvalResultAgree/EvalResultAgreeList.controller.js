...
sap.ui.define([
	...
	function (Common, CommonController, JSONModelHelper, SearchEvalResultAgree) {
	"use strict";
	...
	return CommonController.extend("ZUI5_HR_Dashboard.DashboardList", {
		...
		onBeforeShow : function(oEvent){
			...
			SearchEvalResultAgree.userId = this.getSessionInfoByKey("Pernr");
			SearchEvalResultAgree.Appye = (month < 10 ? (year - 1) + "" : (year + ""));     
			SearchEvalResultAgree.oController = this;  
			
			SearchEvalResultAgree.onBeforeOpen();
		...
		onAfterShow : function(oEvent){
			...
			SearchEvalResultAgree.onAfterOpen();
