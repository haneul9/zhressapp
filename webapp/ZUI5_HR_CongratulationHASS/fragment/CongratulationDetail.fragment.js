...
sap.ui.define(
    ...
    function (Common) {
        ...
        sap.ui.jsfragment("ZUI5_HR_CongratulationHASS.fragment.CongratulationDetail", {
                ...
                var applyBox = new sap.m.FlexBox(oController.PAGEID + "_applyBox", {
                    ...
                    items: [
                        new sap.m.HBox({
                            ...
                            width : "100%",
                            items: [
                                new common.TMEmpBasicInfoBox(oController.SearchModel).addStyleClass("w-100 mt-15px mb-5px")
                            ]
                        }),
                        new sap.m.FlexBox({
                            items: [
