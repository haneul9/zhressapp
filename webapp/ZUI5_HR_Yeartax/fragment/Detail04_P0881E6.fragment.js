sap.ui.jsfragment("ZUI5_HR_Yeartax.fragment.Detail04_P0881E6", {
	...
	createContent : function(oController) {
			...
			extension : [new sap.m.Toolbar({
							 ...
							 content : [new sap.m.Button({
											...
											press : function(oEvent){
												oController.onAddLine2(oEvent, "P0881E6", "E6");
											}
									   ...
									   new sap.m.Button({
											...
											press : function(oEvent){
												oController.onDeleteLine(oEvent, "P0881E6", "E6");
											}
									   }).addStyleClass("button-light"),
		...
		var col_info = [{id: "Ldnam", label : "대주", plabel : "", span : 0, type : "inputtext", editable : true, sort : true, filter : true},
			 			{id: "Ldreg", label : "주민등록번호", plabel : "", span : 0, type : "inputregnr", editable : true, sort : true, filter : true},
		...
		var oDialog = new sap.m.Dialog({
			...
			beginButton : [new sap.m.Button({
								...
								press : function(oEvent){
									oController.onPressSaveSubty(oEvent, "P0881E6", "E6");
								}
