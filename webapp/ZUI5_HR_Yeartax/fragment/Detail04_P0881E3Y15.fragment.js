sap.ui.jsfragment("ZUI5_HR_Yeartax.fragment.Detail04_P0881E3Y15", {
	/** 그 밖의 소득공제 (주택마련저축) **/
	createContent : function(oController) {
		
		var oTable = new sap.ui.table.Table(oController.PAGEID + "_P0881E3Y15Table", {
			...
			extension : [new sap.m.Toolbar({
							 ...
							 content : [new sap.m.Button({
											...
											press : function(oEvent){
												oController.onAddLine2(oEvent, "P0881E3Y15", "E3");
											}
									   ...
									   new sap.m.Button({
											...
											press : function(oEvent){
												oController.onDeleteLine(oEvent, "P0881E3Y15", "E3");
											}
									   }).addStyleClass("button-light"),
		...
		var col_info = [{id: "Pnsty", label : "유형", plabel : "", span : 0, type : "combobox", editable : true, sort : true, filter : true, width : "250px"},
			 			{id: "Finco", label : "금융사", plabel : "", span : 0, type : "combobox", editable : true, sort : true, filter : true, width : "250px"},
		...
		var oDialog = new sap.m.Dialog({
			...
			beginButton : [new sap.m.Button({
								...
								press : function(oEvent){
									oController.onPressSaveSubty(oEvent, "P0881E3Y15", "E3");
								}
