sap.ui.define(
    ...
    function (Common, ZHR_TABLES, Shift) {
        ...
        var TAB_PAGE_ID = [$.app.CONTEXT_PATH, Shift.Tab.APPROVAL].join(".fragment.");
        ...
        sap.ui.jsfragment(TAB_PAGE_ID, {
                            ...
                            items: [
                                new sap.m.HBox({
                                    items: [
                                        ...
                                        new sap.m.Label({text: "{i18n>LABEL_30012}"}), // 결재상태
                                        new sap.m.ComboBox({
                                            width: "100px",
                                            selectedKey: "{Apstat}",
                                            items: {
            ...
            buildTable: function(oController, ApprovalHandler) {
                var oTable = new sap.ui.table.Table("ApprovalTable", {
                    ...
                    rowSettingsTemplate: new sap.ui.table.RowSettings({
                        highlight: {
                            ...
                            formatter: function (v) {
                                switch(v) {
                                    case Shift.Approval.NONE:
                                        return sap.ui.core.IndicationColor.Indication01;
                                    case Shift.Approval.IN_PROCESS:
                                        return sap.ui.core.IndicationColor.Indication02;
                                    case Shift.Approval.REJECT:
                                        return sap.ui.core.IndicationColor.Indication03;
                                    case Shift.Approval.DONE:
                ...
                ZHR_TABLES.makeColumn(oController, oTable, [
                    ...
                    { id: "Begda", label: "{i18n>LABEL_30011}" /* 대상기간 */, plabel: "", resize: true, span: 0, type: "template", sort: true, filter: true, width: "17%", templateGetter: "getDateRangeText", templateGetterOwner: ApprovalHandler },
                    { id: "Rtext", label: "{i18n>LABEL_30005}" /* 근무일정 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "14%", align: sap.ui.core.HorizontalAlign.Begin },
                    { id: "Status1Txt", label: "{i18n>LABEL_30013}" /* 진행상태 */, plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "10%" },
                    { id: "Appkey1", label: "{i18n>LABEL_30014}" /* 결재번호 */, plabel: "", resize: true, span: 0, type: "template", sort: true, filter: true, width: "14%", templateGetter: "getAppkeyLink", templateGetterOwner: ApprovalHandler },
                    { id: "Appdt", label: "{i18n>LABEL_30018}" /* 신청일 */, plabel: "", resize: true, span: 0, type: "date", sort: true, filter: true, width: "10%" }
                ]);
