...
sap.ui.define(["../common/Common", "../common/CommonController", "../common/JSONModelHelper", "../common/PageHelper", "../common/EmployeeModel", "../common/HoverIcon", "sap/m/InputBase"], function (Common, CommonController, JSONModelHelper, PageHelper, EmployeeModel, HoverIcon, InputBase) {
    "use strict";
    ...
    return CommonController.extend("ZUI5_HR_MedApply.MedApply", {
        ...
        getSelector: function (vSig) {
            ...
            var vData = { IConType: "0", IBukrs: oController._Bukrs, IPernr: oSessionData.Pernr, ILangu: oSessionData.Langu, IDatum: "/Date(" + new Date().getTime() + ")/", MedicalApplyExport: [], MedicalApplyTableIn: [], MedicalApplyTableIn0: [], MedicalApplyTableIn3: [], MedicalApplyTableIn4: [], MedicalApplyTableIn5: [], MedicalApplyTableInH: [] };
        ...
        onBeforeShow: function (oEvent) {
            ...
            oModel.create(
                ...
                { Pernr: oSessionData.Pernr, Datum: new Date(), MedicalBukrsExport: [] },
                null,
                function (data, res) {
        ...
        getBukrs: function (vDatum) {
			...
			function getBukrs() {
                oModel.create(
                    "/MedicalBukrsImportSet",
                    { Pernr: oSessionData.Pernr, Datum: "/Date(" + new Date(vDatum.getValue()).getTime() + ")/", MedicalBukrsExport: [] },
                    {
        ...
        onAfterOpen: function () {
            ...
            var vAppnm = "";
            oController._onDialog == "M"
                ? (vAppnm = $.app
                      .byId(oController.PAGEID + "_Dialog")
                      .getModel()
                      .getProperty("/Pop1")[0].Appnm)
                : null;
        ...
        getTxt: function (vTxt, vNo) {
            ...
            var oTxt =
                vNo <= 23 || vNo == 48 || vNo == 49 || vNo == 63 || vNo == 64 || vNo == 65 || vNo == 66 || vNo == 67 || vNo == 68 || vNo == 69 || vNo == 70 || vNo == 71 || vNo == 75 || vNo == 76 || vNo == 89
                    ? "<span style='font-weight:bold;font-size:14px;'>" + oBundleText.getText(vTxt) + "</span>" + redStar
        ...
        changeSel: function (vSig) {
            ...
            $.app
                .byId(oController.PAGEID + "_Dialog")
                .getModel()
                .setProperty("/Pop1/0/RelationTx", oSel.getSelectedItem().getCustomData()[0].getValue("Data"));
                ...
                if (oPro.HospType != "05") {
                    if (oPro.Relation != "01" && oPro.Relation != "02") {
                        $.app
                            .byId(oController.PAGEID + "_Dialog")
                            .getModel()
                            .setProperty("/Pop1/0/Chk1", false);
                        $.app
                            .byId(oController.PAGEID + "_Dialog")
                            .getModel()
                            .setProperty("/Pop1/0/Chk2", false);
        ...
        getSelData: function () {
            ...
            var vData = { ICodeT: "004", IPernr: oSessionData.Pernr, IBukrs: oController._Bukrs, NavCommonCodeList: [], ICodty: "ZHOSP_TYPE" };
            oModel.create(
            ...
            sap.m.MessageBox.alert(oBundleText.getText("MSG_47033"), {
                onClose: function () {
                    ...
                    $.app
                        .byId(oController.PAGEID + "_Dialog")
                        .getModel()
                        .setProperty("/Pop1/0/HospName", oData.HospName);
                    $.app
                        .byId(oController.PAGEID + "_Dialog")
                        .getModel()
                        .setProperty("/Pop1/0/Comid", oData.Comid);
        ...
        clickNotice: function () {
            ...
            function onSave() {
                ...
                sap.m.MessageBox.show(oBundleText.getText("MSG_35001"), {
            ...
            if (!oController.oDialog4) {
                ...
                var mDialog = new sap.m.Dialog(oController.PAGEID + "_pDial", {
                    ...
                    buttons: [new sap.m.Button({ text: oBundleText.getText("LABEL_47101"), press: onSave }).addStyleClass("button-search btn-margin"), new sap.m.Button({ text: oBundleText.getText("LABEL_00133"), press: closeDialog }).addStyleClass("button-delete")],
                    contentWidth: "480px",
        ...
        onValid: function (oController) {
            ...
            if (oController._Bukrs == "1000") {
                ...
                if (oPro.Zkibbm.trim() != "0" && fragment.COMMON_ATTACH_FILES.getFileLength(oController, "009") === 0) {
                    oMsg = oBundleText.getText("MSG_47021");
                }
                if (oPro.Zkijbm.trim() != "0" && fragment.COMMON_ATTACH_FILES.getFileLength(oController, "009") === 0) {
                    oMsg = oBundleText.getText("MSG_47021");
                }
                ...
                if (oPro.Znobcm.trim() != "0" && fragment.COMMON_ATTACH_FILES.getFileLength(oController, "009") === 0) {
                    oMsg = oBundleText.getText("MSG_47021");
                }
        ...
        onCal: function (vSig, vSig2) {
            ...
            var dateFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({ pattern: "yyyy-MM-dd" });
            var vTmp = false;
            var vData = { IConType: "C", IBukrs: vSig, IPernr: oSessionData.Pernr, ILangu: oSessionData.Langu, IMolga: oSessionData.Molga, MedicalApplyExport: [], MedicalApplyTableIn: [], MedicalApplyTableIn0: [], MedicalApplyTableIn3: [], MedicalApplyTableIn4: [], MedicalApplyTableIn5: [], MedicalApplyTableInH: [] };
            if (vSig == "1000") {
            ...
            vSig == "1000" ? ($.app.getController()._DataModel.getProperty("/Pop1")[0].Close = oController._onClose) : ($.app.getController()._DataModel.getProperty("/Pop2")[0].Close = oController._onClose);
            if (vSig == "1000") {
        ...
        onSaveProcess: function (oController, vSig) {
            ...
            if (oCal) {
                ...
                if (vSig == "1000") {
                    ...
                    fragment.COMMON_ATTACH_FILES.getFileLength(oController, "009") != 0 ? uFiles.push("009") : null;
        ...
        eqFunc: function () {
            ...
            if (oController._Bukrs == "1000") {
                ...
                oPro.Zniiwd = common.Common.numberWithCommas(Math.round((parseInt(oPro.Zniiwm.replace(/\,/gi, "")) * 0.5).toFixed(1)));
                oPro.Znisdd = oPro.Znisdm;
                oPro.Znoctd = oPro.Znoctm;
                oPro.Znomrd = oPro.Znomrm;
                oPro.Znocud = oPro.Znocum;
                oPro.Znobcd = common.Common.numberWithCommas(Math.round((parseInt(oPro.Znobcm.replace(/\,/gi, "")) * 0.5).toFixed(1)));
                ...
                parseFloat(oPro.BaseAmt.replace(/\,/gi, "")) < 0 ? (oPro.BaseAmt = "0") : null;
                oPro.NsuppAmt = common.Common.numberWithCommas(parseInt(oPro.BaseAmt.replace(/\,/gi, "")) - parseInt(oPro.SuppAmt.replace(/\,/gi, "")));
                ...
                if ($.app.byId(oController.PAGEID + "_dSel3").getSelectedKey() != "C" && $.app.byId(oController.PAGEID + "_dSel3").getSelectedKey() != "D") {
                    oPro.Medmp = common.Common.numberWithCommas(parseInt((parseInt(oPro.Medsp.replace(/\,/gi, "")) * 0.1 + parseInt(oPro.Medpp.replace(/\,/gi, "")) * 0.2).toFixed(1)));
                } else {
                    oPro.Medmp = "0";
                }
                if (oPro.Gtz51 == "D") {
                    ...
                    if (parseInt(oPro.Zdbcrl.replace(/\,/gi, "")) < parseInt(oPro.Medsp.replace(/\,/gi, "")) + parseInt(oPro.Znobcd.replace(/\,/gi, ""))) {
                        ...
                        oPro.Framt = common.Common.numberWithCommas(parseInt(oPro.Medsp.replace(/\,/gi, "")) + parseInt(oPro.Znobcd.replace(/\,/gi, "")));
                    }
                } else {
                    ...
                    parseFloat(oPro.Framt) < 0 ? $.app.getController()._DataModel.setProperty("/Pop2/0/Framt", "0") : (oPro.Framt = common.Common.numberWithCommas(parseInt(oPro.Framt)));
                }
            }
        },
