...
sap.ui.define([
	...
	return CommonController.extend(SUB_APP_ID, {
		...
		getBukrs : function(vDatum){
			var oController=sap.ui.getCore().byId("ZUI5_HR_MedApply.m.MedApplyDet").getController();
		...
		onAfterOpen:function(){
			...
			oController._vArr1.forEach(function(e){
				...
				eval("oController._DataModel.setProperty('/Pop1/0/"+e+"',common.Common.numberWithCommas(oPro."+e+"))");
			});
		...
		onAfterOpen2 : function(){
			...
			oController._vArr2.forEach(function(e){
				var oPro=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0];
				eval("sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.setProperty('/Pop2/0/"+e+"',common.Common.numberWithCommas(oPro."+e+"))");
			});
			$.app.byId(oController.PAGEID+"_Mat2").bindElement("/Pop2/0");		
			if(oController._onDialog=="M"){
				oController.getSelData2("B");
				$.app.byId(oController.PAGEID+"_dSel5").setSelectedKey(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Relation);
				oController.onChange5("B");				
				$.app.byId(oController.PAGEID+"_dSel6").setSelectedKey(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].PatiName);
				$.app.byId(oController.PAGEID+"_dSel3").setSelectedKey(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Gtz51);
				$.app.byId(oController.PAGEID+"_dSel4").setSelectedKey(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Gtz51s);		
			}else{
		...
		onChk1:function(){
			...
			oController._onDialog=="M"?vAppnm=$.app.byId(oController.PAGEID+"_Mat").getModel().getProperty("/Pop1")[0].Appnm:null;
			if(oController._DataModel.getProperty("/Pop1")[0].Chk1){
				var vProperty1={
					Appnm: vAppnm,
					Mode: "S",
					Cntnm: "001",
		...
		onChk2:function(){
			...
			var vAppnm="",vEdit=true;
			oController._onDialog=="M"?vAppnm=$.app.byId(oController.PAGEID+"_Mat").getModel().getProperty("/Pop1")[0].Appnm:null;
			if(oController._DataModel.getProperty("/Pop1")[0].Chk2){
				var vProperty1={
					Appnm: vAppnm,
					Mode: "S",
					Cntnm: "001",
		...
		oTableInit : function(){
			...
			var oAligns=['Center','Center','Center','Center','Begin','Begin','End','End','End','Center'];	
...
//								oController._onClose="X";
		...
		onCloseMini : function(){
			$.app.byId(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController().PAGEID+"_miniDialog").close();
		},
		...
		changeSel2 : function(){
			...
			if(oSel2.getSelectedKey()=="05"){
				$.app.byId(oController.PAGEID+"_Input1").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input2").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input3").setEditable(false);
				$.app.byId(oController.PAGEID+"_Input3").setValue("0");
				$.app.byId(oController.PAGEID+"_Input4").setEditable(false);
				$.app.byId(oController.PAGEID+"_Input4").setValue("0");
				$.app.byId(oController.PAGEID+"_Input5").setEditable(false);
				$.app.byId(oController.PAGEID+"_Input5").setValue("0");
				$.app.byId(oController.PAGEID+"_Input6").setEditable(false);
				$.app.byId(oController.PAGEID+"_Input6").setValue("0");
				$.app.byId(oController.PAGEID+"_Input7").setEditable(false);
				$.app.byId(oController.PAGEID+"_Input7").setValue("0");
				$.app.byId(oController.PAGEID+"_Input8").setEditable(false);
				$.app.byId(oController.PAGEID+"_Input8").setValue("0");
				$.app.byId(oController.PAGEID+"_Input9").setEditable(true);
			}else{
				$.app.byId(oController.PAGEID+"_Input1").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input2").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input3").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input4").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input5").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input6").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input7").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input8").setEditable(true);
				$.app.byId(oController.PAGEID+"_Input9").setEditable(false);
				$.app.byId(oController.PAGEID+"_Input9").setValue("0");
			}
			oController.eqFunc();
		},
		...
		onCal : function(vSig,vSig2){
			...
			if(vSig=="1000"){
				vData.MedicalApplyTableIn.push(oController._DataModel.getProperty("/Pop1")[0]);				
				oController._vArr1.forEach(function(e){
			...
			vSig=="1000"?vData.IMedDate=oController._DataModel.getProperty("/Pop1")[0].MedDate:vData.IMedDate=oController._DataModel.getProperty("/Pop2")[0].MedDate;
			oModel.create("/MedicalApplySet", vData, null,
					function(data,res){
						if(data&&data.MedicalApplyTableIn.results.length){
							if(vSig=="1000"){
			...
			vSig=="1000"?oController._DataModel.getProperty("/Pop1")[0].Close=oController._onClose:
						 oController._DataModel.getProperty("/Pop2")[0].Close=oController._onClose;
			if(vSig=="1000"){
				vData.MedicalApplyTableIn[0].Zfvcgb=="X"?oController._DataModel.getProperty("/Pop1")[0].Chk1=true:
				oController._DataModel.getProperty("/Pop1")[0].Chk1=false;
				vData.MedicalApplyTableIn[0].Ziftgb=="X"?oController._DataModel.getProperty("/Pop1")[0].Chk2=true:
				oController._DataModel.getProperty("/Pop1")[0].Chk2=false;
				oController._vArr1.forEach(function(e){
					var oPro=oController._DataModel.getProperty("/Pop1")[0];
				...
				oController._vArr2.forEach(function(e){
					...
					eval("oController._DataModel.setProperty('/Pop2/0/"+e+"',common.Common.numberWithCommas(oPro."+e+"))");
				});
			}
			return vTmp;
		},
		...
		onLiveMoney : function(oEvent){
			...
			sap.ui.getCore().byId("ZUI5_HR_MedApply.m.MedApplyDet").getController().eqFunc();
		},
		
		eqFunc:function(){
			var oController=sap.ui.getCore().byId("ZUI5_HR_MedApply.m.MedApplyDet").getController();
			if(oController._Bukrs=="1000"){
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkiobd=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkibbm;
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkijbd=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkijbm;
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znijcd=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znijcm;
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zniiwd=common.Common.numberWithCommas(Math.round(
					(parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zniiwm.replace(/\,/gi,""))*0.5).toFixed(1)));
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znisdd=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znisdm;
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znoctd=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znoctm;
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znomrd=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znomrm;
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znocud=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znocum;
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znobcd=common.Common.numberWithCommas(Math.round(
					(parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znobcm.replace(/\,/gi,""))*0.5).toFixed(1)));
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].BaseAmt=common.Common.numberWithCommas(
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkiobd.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkijbd.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znijcd.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zniiwd.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znisdd.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znoctd.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znocud.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znobcd.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znomrd.replace(/\,/gi,"")));
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].NsuppAmt=common.Common.numberWithCommas(
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].BaseAmt.replace(/\,/gi,""))-
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].SuppAmt.replace(/\,/gi,"")));
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Mycharge=common.Common.numberWithCommas(
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkibbm.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zkijbm.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znijcm.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Zniiwm.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znisdm.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znoctm.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znomrm.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znocum.replace(/\,/gi,""))+
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop1")[0].Znobcm.replace(/\,/gi,"")));
			}else{
				sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Znobcd=common.Common.numberWithCommas(Math.round(
					(parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Znobcm.replace(/\,/gi,""))*0.5).toFixed(1)));
				if($.app.byId(oController.PAGEID+"_dSel3").getSelectedKey()!="C"&&$.app.byId(oController.PAGEID+"_dSel3").getSelectedKey()!="D"){
					sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Medmp=common.Common.numberWithCommas(parseInt(
					(parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Medsp.replace(/\,/gi,""))*0.1
					+parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Medpp.replace(/\,/gi,""))*0.2).toFixed(1)));
				}else{
					sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Medmp="0";
				}
				if(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Gtz51=="D"){
					sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Framt=sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Medpp;
				}else if(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Gtz51=="C"){
					sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Framt=common.Common.numberWithCommas(
						parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Medpp.replace(/\,/gi,""))+
						parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Znobcd.replace(/\,/gi,"")));
				}else{
					sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Framt=
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Ptamt.replace(/\,/gi,""))
					-parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Inspp.replace(/\,/gi,""))-
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Medmp.replace(/\,/gi,""))
					-parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Insnp.replace(/\,/gi,""))-
					parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Oiamt.replace(/\,/gi,""))
					sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Framt<0?sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Framt=0:
					sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Framt=common.Common.numberWithCommas(parseInt(sap.ui.getCore().byId('ZUI5_HR_MedApply.m.MedApplyDet').getController()._DataModel.getProperty("/Pop2")[0].Framt));
				}
			}			
		},
