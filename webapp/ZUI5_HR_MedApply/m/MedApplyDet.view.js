...
                valueHelpRequest: oController.onSearchMed,editable:{parts:[{path:"Close"},{path:"Status"}],
	...
	//비급여 내역
        ...
        formatter:function(fVal,fVal2){
			...
			oRow.addCell(oCell);
			oCell=new sap.ui.commons.layout.MatrixLayoutCell({hAlign:"Begin",content:[new sap.m.Input({width:"90%",textAlign:"End",liveChange:oController.onLiveMoney,maxLength:13,value:"{Mycharge}",editable:false})]});
			oRow.addCell(oCell);
			oMat.addRow(oRow);
			...
			oRow.addCell(oCell);
			oCell=new sap.ui.commons.layout.MatrixLayoutCell({hAlign:"Begin",content:[new sap.m.Input({width:"90%",textAlign:"Right",liveChange:oController.onLiveMoney,maxLength:13,value:"{Zdsctm}",editable:{parts:[{path:"Close"},{path:"Status"}],
			formatter:function(fVal,fVal2){
				if(fVal2==""){
					return fVal=="X"?false:true;
				}else{
			...
			oRow.addCell(oCell);
			oCell=new sap.ui.commons.layout.MatrixLayoutCell({hAlign:"Begin",content:[new sap.m.Input({width:"90%",textAlign:"End",liveChange:oController.onLiveMoney,maxLength:13,value:"{BaseAmt}",editable:false})]});
			oRow.addCell(oCell);
			oMat.addRow(oRow);
			...
			oRow.addCell(oCell);
			oCell=new sap.ui.commons.layout.MatrixLayoutCell({hAlign:"Begin",content:[new sap.m.Input({width:"90%",textAlign:"End",liveChange:oController.onLiveMoney,maxLength:13,value:"{SuppAmt}",editable:false})]});
			oRow.addCell(oCell);
			oMat.addRow(oRow);
			...
			oRow.addCell(oCell);
			oCell=new sap.ui.commons.layout.MatrixLayoutCell({hAlign:"Begin",content:new sap.m.Input({width:"90%",textAlign:"Right",
