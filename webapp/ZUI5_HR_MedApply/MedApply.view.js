        ...
        sap.ui.jsview("ZUI5_HR_MedApply.MedApply", {
            ...
            buildTableBox: function (oController) {
                ...
                var columnModels = [
                    ...
                    { id: "PatiName", label: "{i18n>LABEL_47093}" /*환자명*/ , plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "10%" },
                    ...
                    { id: "DiseName", label: "{i18n>LABEL_47096}" /*진료내용*/ , plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "16%", align: "Begin" },
                                ...
                                content: [
                                    new sap.m.Button(oController.PAGEID + "_NewBtn", {
                                        ...
                                        press: function () {
                                            ...
                                            oController._GubunBukrs = oController.getSessionInfoByKey("Bukrs3");
