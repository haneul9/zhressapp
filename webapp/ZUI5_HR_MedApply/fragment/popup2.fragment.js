                    ...
                    headerToolbar: [
                        new sap.m.Toolbar({
                            content: [
                                ...
                                new sap.ui.core.HTML({ content: "<a target='_blank' href='ZUI5_HR_MedApply/manual/MedApplyCalcHigh.xls' style='font-size:14px;color:#0070bd !important;padding-right:15px;' download>" + oController.getBundleText("LABEL_47143") + "</a>" })    // 첨단 치과(보철) 회사 양식
                            ]
                        })
                    ],
                    content: new MatrixLayout({
