...
sap.ui.jsfragment("ZUI5_HR_BusinessTripMap.fragment.SettlementDetailDialog", {
	...
	createContent: function(oController) {
		...
		var oDialog = new sap.m.Dialog({
			...
			contentWidth: "1600px",
			contentHeight: "96%",
			content: sap.ui.jsfragment("ZUI5_HR_BusinessTripMap.fragment.SettlementDetail", oController),
			draggable: true,
			buttons: [
				new sap.m.Button({
