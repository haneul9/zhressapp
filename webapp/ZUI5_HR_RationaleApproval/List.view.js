...
sap.ui.jsview("ZUI5_HR_RationaleApproval.List", {
	...
	createContent: function(oController) {
		...
		var col_info = [{id: "Idx", label: "No.", plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "60px"},
						...
						{id: "Begda", label: oBundleText.getText("LABEL_67005"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true},
						...
						// 입문시간, 출문시간, 근태여부, 신청유형
						{id: "Entbg", label: oBundleText.getText("LABEL_67007"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "85px"},
						{id: "Enten", label: oBundleText.getText("LABEL_67008"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "85px"},
						...
						// 출근시간, 퇴근시간, 인정시간, 반려사유
						{id: "Enfbg", label: oBundleText.getText("LABEL_67011"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "85px"},
						{id: "Enfen", label: oBundleText.getText("LABEL_67012"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "85px"},
						{id: "Time", label: oBundleText.getText("LABEL_67013"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "85px"},
						{id: "Retrn", label: oBundleText.getText("LABEL_67014"), plabel: "", resize: true, span: 0, type: "formatter", sort: true, filter: true, width : "25%"}];
