...
sap.ui.controller("ZUI5_SF_EvalGoal.EvalGoalList", {
	PAGEID : "EvalGoalList",
...
//		bus.subscribe("app", "OpenWindow", this.SmartSizing, this);
	...
	onBeforeShow : function(oEvent){
		...
		if(!oController._StatusMessage){
			...
			var vData = {
				Data : [{Type : "Warning", Text : oBundleText.getText("MSG_05005")}, // 피평가자 목록 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05006")}, // 평가문서 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05007")}, // 평가문서 상태 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05008")}, // 목표 개수 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05009")}, // 활동 개수 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05010")}, // 실적 개수 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05011")}, // Rating 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05012")}] // Summary 데이터 집계
			};
	...
	onSearchUserList : function(oEvent){
		...
		oController._StatusMessage.getModel().setProperty("/Data/0", {Type : "Success", Text : oBundleText.getText("MSG_05013")}); // 피평가자 목록 조회 완료
	},
	...
	onPressSearch : function(oEvent){
		...
		if(oEvent){
			var vData = {
				Data : [{Type : "Success", Text : oBundleText.getText("MSG_05013")}, // 피평가자 목록 조회 완료
						{Type : "Warning", Text : oBundleText.getText("MSG_05006")}, // 평가문서 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05007")}, // 평가문서 상태 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05008")}, // 목표 개수 조회
						{Type : "Warning", Text : oBundleText.getText("MSG_05009")}, // 활동 개수 조회
		 		...
		 		setTimeout(function(){
					...
					for(var a=0; a<goal.length; a++){
		 			...
		 			Promise.all(promise2).then(function(){
		 				...
		 				oController._StatusMessage.getModel().setProperty("/Data/1", {Type : "Success", Text : oBundleText.getText("MSG_05014")}); // 평가문서 조회 완료
			 			...
			 			for(var i=0; i<oData2.Data.length; i++){
			 				...
			 				oController._StatusMessage.getModel().setProperty("/Data/4", {Type : "Success", Text : oBundleText.getText("MSG_05017")}); // 활동 개수 조회 완료
			 				...
			 				oController._StatusMessage.getModel().setProperty("/Data/5", {Type : "Success", Text : oBundleText.getText("MSG_05018")}); // 실적 개수 조회 완료
			 				...
			 				oController._StatusMessage.getModel().setProperty("/Data/2", {Type : "Success", Text : oBundleText.getText("MSG_05015")}); // 평가문서 상태 조회 완료
			 				...
			 				oController._StatusMessage.getModel().setProperty("/Data/6", {Type : "Success", Text : oBundleText.getText("MSG_05015")}); // Rating 조회 완료
			 				...
			 				oController._StatusMessage.getModel().setProperty("/Data/3", {Type : "Success", Text : oBundleText.getText("MSG_05016")}); // 목표 개수 조회 완료
			 			...
			 			oController._StatusMessage.getModel().setProperty("/Data/7", {Type : "Success", Text : oBundleText.getText("MSG_05020")}); // Summary 데이터 집계 완료
