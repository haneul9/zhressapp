...
sap.ui.jsview($.app.APP_ID, { // 업적&역량 평가
	...
	createContent: function(oController) {
			...
			items: [
				new sap.m.FlexBox({ // 검색
					...
					items: [
						...
						new sap.m.FlexBox("EvalExceptTypeComboBox", { // 예외설정이 존재하는 경우 보여짐
							visible: false,
							items: [
		...
		.addStyleClass("search-box h-auto");
		...
		.addStyleClass("multi-header fix-header-height-38px custom-progress-indicator mt-10px")
