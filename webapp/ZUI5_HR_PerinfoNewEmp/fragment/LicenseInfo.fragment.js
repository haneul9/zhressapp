sap.ui.define(
    ...
    function (Common) {
        ...
        sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.LicenseInfo", {
                                        ...
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    ...
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordLicense", "LicnNum")
                                                })
                                            ]
                                        }).addStyleClass("toolbarNoBottomLine")
                                    ],
                                        ...
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    ...
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordLicense", "Zbigo")
                                                })
                                            ]
                                        }).addStyleClass("toolbarNoBottomLine")
                                    ],
