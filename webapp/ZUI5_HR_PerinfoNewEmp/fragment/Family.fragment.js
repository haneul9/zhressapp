sap.ui.define(
    ...
    function (MakeTable) {
        ...
        sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.Family", {
            ...
            createContent: function (oController) {
                ...
                var col_info = [
                    { id: "Idx", label: "{i18n>LABEL_13005}", plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width: "80px" },
                            ...
                            cells: [
                                new sap.ui.commons.layout.MatrixLayoutCell({
                                    content: [
                                        new sap.m.Toolbar({
                                            content: [
                                                new sap.m.Text({ text: "{i18n>LABEL_37106}" }).addStyleClass("sub-title") // 가족사항
                                            ]
                                        })
