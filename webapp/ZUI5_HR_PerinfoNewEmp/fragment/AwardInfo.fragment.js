sap.ui.define(
    ...
    function (Common) {
        ...
        sap.ui.jsfragment("ZUI5_HR_ZUI5_HR_PerinfoNewEmpPerinfo.fragment.AwardInfo", {
                                        ...
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    ...
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordAward", "Zzreason")
                                                })
                                            ]
                                        }).addStyleClass("toolbarNoBottomLine")
                                    ],
                                        ...
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    ...
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordAward", "Prins")
                                                })
                                            ]
                                        }).addStyleClass("toolbarNoBottomLine")
                                    ],
                                        ...
                                        new sap.m.Toolbar({
                                            content: [
                                                new sap.m.Input({
                                                    ...
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordAward", "Prtyp")
                                                })
                                            ]
                                        }).addStyleClass("toolbarNoBottomLine")
                                    ],
