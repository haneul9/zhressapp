sap.ui.define(
    ...
    function (Common) {
        ...
        sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.Military", {
                                        ...
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Idnum}",
                                                    width: "250px",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordMilitaryTableIn", "Idnum"),
                                                    editable: {
                                                        path: "disyn",
                                                        formatter: function (v) {
                                                            if (v === "1") return true;
                                    ...
                                    content: [
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Serut}",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordMilitaryTableIn", "Serut"),
                                                    width: "250px",
                                                    editable: {
                                                        path: "disyn",
                                                        formatter: function (v) {
                                    ...
                                    content: [
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Rsexp}",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_RECORD_SRV", "PerRecordMilitaryTableIn", "Rsexp"),
                                                    width: "250px",
                                                    editable: {
                                                        path: "disyn",
                                                        formatter: function (v) {
