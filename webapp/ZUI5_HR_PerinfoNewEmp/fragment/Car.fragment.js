sap.ui.define(
    ...
    function (Common) {
        ...
        sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.Car", {
                                        ...
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Cartype}",
                                                    width: "250px",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoCarmanagerTableIn", "Cartype"),
                                                    editable: {
                                                        path: "disyn",
                                                        formatter: function (v) {
                                                            if (v === "1") return true;
                                    ...
                                    content: [
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Carnum}",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoCarmanagerTableIn", "Carnum"),
                                                    width: "250px",
                                                    editable: {
                                                        path: "disyn",
                                                        formatter: function (v) {
                                        ...
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Bagirang}",
                                                    width: "250px",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoCarmanagerTableIn", "Bagirang"),
                                    ...
                                    content: [
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Addcartype}",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoCarmanagerTableIn", "Addcartype"),
                                                    width: "250px",
                                                    editable: {
                                                        path: "disyn",
                                                        formatter: function (v) {
                                    ...
                                    content: [
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Addcarnum}",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoCarmanagerTableIn", "Addcarnum"),
                                                    width: "250px",
                                                    editable: {
                                                        path: "disyn",
                                                        formatter: function (v) {
                                    ...
                                    content: [
                                        new sap.m.Toolbar({
                                            ...
                                            content: [
                                                new sap.m.Input({
                                                    value: "{Bagirang2}",
                                                    maxLength: Common.getODataPropertyLength("ZHR_PERS_INFO_SRV", "PerinfoCarmanagerTableIn", "Bagirang2"),
                                                    width: "250px",
                                                    type: sap.m.InputType.Number,
                                                    textAlign: sap.ui.core.TextAlign.End,
                                                    editable: {
