        ...
        return CommonController.extend("ZUI5_HR_PerinfoNewEmp.List", {
            ...
            onAddressDblClick: function (actMode) {
                ...
                if (!oController._AddressDialog) {
                    oController._AddressDialog = sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.AddressInfo", oController);
            ...
            onPassportDblClick: function (actMode) {
                ...
                if (!oController._PassportDialog) {
                    oController._PassportDialog = sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.PassportInfo", oController);
            ...
            onSchoolDblClick: function (actMode) {
                ...
                if (actMode != "4") {
                    ...
                    if (!oController._SchoolDialog) {
                        oController._SchoolDialog = sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.SchoolInfo", oController);
            ...
            onLicenseDblClick: function (actMode) {
                ...
                if (actMode != "4") {
                    ...
                    if (!oController._LicenseDialog) {
                        oController._LicenseDialog = sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.LicenseInfo", oController);
            ...
            onCareerDblClick: function (actMode) {
                ...
                if (actMode != "4") {
                    ...
                    if (!oController._CareerDialog) {
                        oController._CareerDialog = sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.CareerInfo", oController);
            ...
            onAwardDblClick: function (actMode) {
                ...
                if (actMode != "4") {
                    ...
                    if (!oController._AwardDialog) {
                        oController._AwardDialog = sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.AwardInfo", oController);
			...
			changePicture : function(){
				...
				if (!oController._ChangePictureDialog) {
                    oController._ChangePictureDialog = sap.ui.jsfragment("ZUI5_HR_PerinfoNewEmp.fragment.PictureInfo", oController);
