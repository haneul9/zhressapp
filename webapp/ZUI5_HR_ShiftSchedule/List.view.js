...
sap.ui.jsview("ZUI5_HR_ShiftSchedule.List", {
	
	getControllerName: function() {
		return "ZUI5_HR_ShiftSchedule.List";
	},
	...
	createContent: function(oController) {
        ...
        var oLayout = new sap.ui.layout.VerticalLayout(oController.PAGEID + "_Layout").addStyleClass("pt-10px pb-10px");
