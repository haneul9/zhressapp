	...
	createContent : function(oController) {
		...
		if(oController._ListCondJSonModel.getProperty("/Data/Disty") == "1"){ // 부서별
			...
			col_info = [{id: "Idx", label: "No.", plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "60px"},
						{id: "Orgtx", label: oBundleText.getText("LABEL_00122"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "20%"},
						{id: "Empcnt", label: oBundleText.getText("LABEL_41009"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true},
						// 한도(기본,연장)
						{id: "Hrs10", label: oBundleText.getText("LABEL_46014"), plabel: oBundleText.getText("LABEL_46015"), resize: true, span: 2, type: "string", sort: true, filter: true},
						{id: "Hrs11", label: oBundleText.getText("LABEL_46014"), plabel: oBundleText.getText("LABEL_46016"), resize: true, span: 0, type: "string", sort: true, filter: true},
						// 근무시간(기본,연장,소계)
						{id: "Hrs20", label: oBundleText.getText("LABEL_46018"), plabel: oBundleText.getText("LABEL_46015"), resize: true, span: 3, type: "string", sort: true, filter: true},
						{id: "Hrs21", label: oBundleText.getText("LABEL_46018"), plabel: oBundleText.getText("LABEL_46016"), resize: true, span: 0, type: "string", sort: true, filter: true},
						{id: "Hrs22", label: oBundleText.getText("LABEL_46018"), plabel: oBundleText.getText("LABEL_46017"), resize: true, span: 0, type: "string", sort: true, filter: true},
						// 근무시간(평일)(기본,연장,소계)
						...
						// 심야
						{id: "Hrs50", label: oBundleText.getText("LABEL_46021"), plabel: oBundleText.getText("LABEL_41017"), resize: true, span: 0, type: "string", sort: true, filter: true}];
			...
			col_info = [{id: "Idx", label: "No.", plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "60px"},
						...
						{id: "Orgtx", label: oBundleText.getText("LABEL_00122"), plabel: "", resize: true, span: 0, type: "string", sort: true, filter: true, width : "15%"},
						// 한도(기본,연장)
						{id: "Hrs10", label: oBundleText.getText("LABEL_46014"), plabel: oBundleText.getText("LABEL_46015"), resize: true, span: 2, type: "string", sort: true, filter: true},
						{id: "Hrs11", label: oBundleText.getText("LABEL_46014"), plabel: oBundleText.getText("LABEL_46016"), resize: true, span: 0, type: "string", sort: true, filter: true},
						// 근무시간(기본,연장,소계)
