sap.ui.define(
    ...
    function (Common, PickOnlyDateRangeSelection, ZHR_TABLES, ODataFileUploader, ViewTemplates) {
        "use strict";
        ...
        sap.ui.jsfragment([$.app.CONTEXT_PATH, "fragment", "RequestList"].join("."), {
            createContent: function (oController) {
                return new sap.m.VBox({
                    height: "100%",
                    items: [this.getSearchHBox(oController), this.getInfoHBox(oController), this.getTable(oController)]
                });
            },
                    ...
                    items: [
                        new sap.m.HBox({
                            items: [
                                ...
                                new sap.m.Text({ text: "{ETitle}" }).setModel(oController._ListCondJSonModel).bindElement("/Info").addStyleClass("color-blue") // 신청현황
                            ]
                        ...
                        new sap.m.HBox({
                            items: [
								...
								new sap.m.Button({
                                    press: oController.pressExcelDownloadBtn.bind(oController),
            ...
            getTable: function (oController) {
                ...
                ZHR_TABLES.makeColumn(oController, oTable, aColumns);
				oController.aColumnModel = Common.convertColumnArrayForExcel(oController, aColumns);
            ...
            getStatusTextTemplate: function (columnInfo) {
                return new sap.ui.commons.TextView({
                    ...
                    text: {
                        parts: [{ path: columnInfo.id }, { path: "Status" }],
